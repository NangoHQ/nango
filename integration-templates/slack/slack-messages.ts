...
export default async function fetchData(nango: NangoSync): Promise<{SlackMessage: SlackMessage[], SlackMessageReply: SlackMessageReply[], SlackMessageReaction: SlackMessageReaction[] }> {
