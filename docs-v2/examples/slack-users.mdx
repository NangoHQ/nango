...
To run it, [configure a Slack integration](https://app.nango.dev/integration/create), using the _integration_Unique Key `slack-dev` (cf. [Authorize APIs guide](/guides/oauth)).
