...
To run it, [configure a Slack integration](https://app.nango.dev/integration/create), using the Integration Unique Key `slack-dev` (cf. [Authorize APIs guide](/guides/oauth)).
