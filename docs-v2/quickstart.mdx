...
This will use the _connection_ you created in the [Authorize an API section](#authorize-an-api-github) to run your _sync_ script. Synced objects will not be persisted in Nango's storage. It allows you to quickly check if your _sync_ script is correct.
...
Your _sync_ will run on Nango's cloud infrastructure, syncing Github issues for all the Github _connections_, continuously 🎉 You can manage your _syncs_ from the [Syncs tab](https://app.nango.dev/syncs).
