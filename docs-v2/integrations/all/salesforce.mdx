...
<Tabs>
  ...
  **Note:** Connected Apps are disabled by default in new Salesforce organizations. If your organization is creating one, follow **Enable Connected Apps** steps to enable them first. If your organization has already enabled this setting, skip to **Configure Connected App settings**.
