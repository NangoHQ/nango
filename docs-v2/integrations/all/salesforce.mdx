  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Authorize Salesforce">
        Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then login in to Salesforce. Later, you'll let your users do the same directly from your app. 
      </Step>
    ...
    <Tip>
    Next steps: 
    - [Embed the auth flow](/getting-started/quickstart/embed-in-your-app) in your app to let your users connect their Salesforce accounts
