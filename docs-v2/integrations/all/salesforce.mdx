...
<Tabs>
  ...
  **Important**: Due to [Salesforce limitations](https://trailhead.salesforce.com/trailblazer-community/feed/0D54V00007T44UpSAJ), you need **two separate Salesforce accounts**:
  ...
  <Tab title="🚨 API gotchas">
    -   **External Client Apps vs Connected Apps**: Salesforce has transitioned from Connected Apps to External Client Apps. You must choose the Distribution State (Local vs Packaged) upfront. If distributing to other orgs, you need separate accounts for Dev Hub and namespace registration, and must follow the packaging process outlined in the Oauth Setup guide.
