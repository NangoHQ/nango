  ...
  <Steps>
    ...
    <Step title="Enable Connected Apps">
      **Note:** Connected Apps are disabled by default in new Salesforce organizations. If your organization is creating one, follow these steps to enable them first. If your organization has already enabled this setting, skip to **Configure Connected App settings**.
      ...
      2. Navigate to **Setup** → in the left menu, click **Apps** → **External Client App Manager** → **Settings**
      ...
      <Step title="Configure Connected App settings">
        ...
        2. Navigate to **Setup** → in the left menu, click **Apps** → **External Client App Manager** → **Settings**, scroll to the bottom of the page, then click **New Connected App**
