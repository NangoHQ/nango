...
<img src="/integrations/all/jumpcloud/jumpcloud-my-api.png" style={{maxWidth: "450px" }}/>

4. Click **Generate New API Key** to create a new API key

<img src="/integrations/all/jumpcloud/jumpcloud-generate-api.png" style={{maxWidth: "450px" }}/>
