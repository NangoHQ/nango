...
<img src="/integrations/all/jumpcloud/jumpcloud-api-key.png" style={{maxWidth: "450px" }}/>

4. Click **Generate New API Key** to create a new API key

<img src="/integrations/all/jumpcloud/jumpcloud-generate-api-key.png" style={{maxWidth: "450px" }}/>
...
<img src="/integrations/all/jumpcloud/form.png" style={{maxWidth: "450px" }}/>
