...
import PreBuiltTooling from "/snippets/generated/github-app/PreBuiltTooling.mdx"
...
<Steps>
  ...
  <Step title="Install your GitHub App">
    1. Navigate to your GitHub App's public page (the App Public Link noted in the previous step).
    2. Click **Install** or **Configure** to install the app on your account or organization.
    3. Select the repositories you want to give the app access to.
    4. Click **Install**.
    5. After installation, note the **Installation ID** from the URL (e.g., in https://github.com/settings/installations/12345678, the Installation ID is 12345678).
  </Step>
  <Step title="Next">
...
| Developer | [Registering a GitHub App](https://docs.github.com/en/apps/creating-github-apps/registering-a-github-app/registering-a-github-app) |
...
| | [Using Webhooks with GitHub Apps](https://docs.github.com/en/apps/creating-github-apps/setting-up-a-github-app/using-webhooks-with-github-apps) |
...
GitHub Apps use a different authentication flow than standard OAuth. You can configure your connection in Nango using the following parameters:

```json
{
  "appId": "123456",
  "appPublicLink": "https://github.com/apps/your-app-name",
  "privateKey": "YOUR_PRIVATE_KEY"
}
```

The `privateKey` should be the contents of the private key file you downloaded when setting up your GitHub App. Make sure to store this securely and never expose it in client-side code.

To initiate a connection with a GitHub App:

```js
nango.auth('github-app', '<CONNECTION-ID>');
```

This will redirect the user to the GitHub App installation page. After installation, the user will be redirected back to your application.
...
-   GitHub Apps use installation tokens that are scoped to specific repositories. These tokens expire after 1 hour and need to be refreshed.
...
-   GitHub Apps can create and manage fine-grained personal access tokens (PATs) for users who have authorized the app.
