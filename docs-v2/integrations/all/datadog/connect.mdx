...
#### Step 1: Finding Your Datadog Domain and Datadog API Key and credentials
...
3. To add a Datadog API key, Navigate to **Organization settings**, then click the **API keys** tab.
...
4. To create a new application key, navigate to **Organization Settings** > **Application Keys**. If you have the permission to create application keys, click **New Key**.

<img src="/integrations/all/datadog/datadog-2.avif" />


5. Once you’ve clicked this, you’ll see a pop-up that confirms that this API key will replace the one used for GDPR compliance and personal data storage. 
...
#### Step 2: Connect Your Datadog Account
...
<Card title="Connect to datadog" icon="link" href="/integrations/all/datadog/connect" horizontal>
  Guide to connect to datadog using Connect UI
</Card>