...
#### Step 2: Datadog API Key and credentials
...
2. To create a new application key, navigate to **Organization Settings** > **Application Keys**. If you have the permission to create application keys, click **New Key**.

<img src="/integrations/all/datadog/datadog-2.avif" />


3. Once you’ve clicked this, you’ll see a pop-up that confirms that this API key will replace the one used for GDPR compliance and personal data storage. 
...
#### Step 3: Connect Your Datadog Account
