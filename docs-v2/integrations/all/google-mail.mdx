...
<Tabs>
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Authorize Gmail">
        Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then login in to Gmail. Later, you'll let your users do the same directly from your app. 
      </Step>
      <Step title="Call the Gmail API">
        Let's make your first request to the Gmail API (fetch a list of emails). Replace the placeholders below with your [secret key](https://app.nango.dev/dev/environment-settings), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections):
        <Tabs>
            <Tab title="cURL">

                ```bash
                curl "https://api.nango.dev/proxy/gmail/v1/users/me/messages" \
    ...
    <Tip>
    Next steps: 
    - [Embed the auth flow](/getting-started/quickstart/embed-in-your-app) in your app to let your users connect their Gmail accounts
  ...
  <Tab title="🔗 Useful links">
    | Topic | Links | 
    | - | - | 
    | General | [Website](https://mail.google.com/) |
    | | [Create a test account](https://accounts.google.com/signup) |
    | Developer | [API documentation](https://developers.google.com/gmail/api) |
    | | [Create a developer account](https://console.cloud.google.com/) |
    | | [Developer console](https://console.cloud.google.com/) |
    | | [Authorization documentation](https://developers.google.com/gmail/api/auth/about-auth) |
    | | [Register an OAuth app](https://console.cloud.google.com/apis/credentials) |
    | | [List of OAuth scopes](https://developers.google.com/gmail/api/auth/scopes) |
    | | [Details on rate limits](https://developers.google.com/gmail/api/reference/quota) |
