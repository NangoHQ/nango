...
API configurations: [`twitter`](https://nango.dev/providers.yaml) for OAuth1, [`twitter-v2`](https://nango.dev/providers.yaml) for OAuth2, [`twitter-oauth2-cc`](https://nango.dev/providers.yaml) for client_credentials flow
