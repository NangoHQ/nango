  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Authorize Sellsy (Client Credentials)">
        Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then enter your Sellsy **Client Id** and **Secret shopper**. Later, you'll let your users do the same directly from your app.
      </Step> 
