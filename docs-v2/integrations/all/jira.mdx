...
-   When connecting to Jira, you have two options for specifying which Jira site to connect to:
    1. Provide a `Domain` during connection creation (recommended): This ensures you connect to the specific Jira site you want (e.g., "https://nango-hq.atlassian.net").
