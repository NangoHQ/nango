...
To authenticate with Workday, you need two key piece of information:
1. **Client ID** - Your Workday Client ID
1. **Client Secret** - Your Workday Client Secret
...
#### Step 1: Finding Workday Client ID
...
#### Step 2: Find your token endpoint URL
...
#### Step 2: Connect Your Workday Account
