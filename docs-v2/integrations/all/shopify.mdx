...
<Steps>
  ...
  <Step title="Configure OAuth settings">
    ...
    1. Navigate to the **App setup** tab.
  ...
  <Step title="Set up the OAuth scopes">
    1. Still in the **App setup** tab, scroll down to the **Admin API access scopes** section.
    2. Select the scopes that are relevant to how you want to consume the Shopify API. Common scopes include:
  ...
  <Step title="Obtain API credentials">
    ...
    2. Copy the **Client ID** (also called API key) and **Client secret** (also called API secret key).
...
| | [OAuth getting started guide](https://shopify.dev/docs/apps/auth/oauth/getting-started) |
| | [Register an OAuth app](https://shopify.dev/docs/apps/auth/oauth/getting-started#step-1-create-the-app-in-your-partner-account) |
