...
-   You need to set the correct shop subdomain when you call `nango.auth()` in the frontend. Use the `subdomain` parameter as [explained here](/nango-auth/configuration#connection-configuration).
