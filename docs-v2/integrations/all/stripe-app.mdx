...
<Step title="Obtain your Client ID and Client Secret">
  ...
  2. Locate the <strong>Live mode link</strong> under the <strong>Install link</strong> section. The **Client ID** is included as a query parameter in this URL (e.g., client_id=...).
