...
| [Sync data](/guides/getting-started/read-from-an-api) | 🚫 (see API gotchas) |
| [Perform workflows](/guides/getting-started/write-to-an-api) | 🚫 (see API gotchas) |
| [Proxy requests](/guides/proxy-requests-to-an-api) | 🚫 (see API gotchas) |
