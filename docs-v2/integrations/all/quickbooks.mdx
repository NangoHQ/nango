...
<Steps>
  ...
  <Step title="Create a new app in your Developer account">
    1. From your Developer Dashboard, navigate to **Dashboard** > **My Apps** > **Create an app**.
    2. Select **QuickBooks Online and Payments** and provide a name for your app.
    3. Click **Create app** to proceed.
  </Step>
  <Step title="Configure OAuth settings">
    In the app you just created:
    1. Navigate to the **Development** tab in your app's dashboard.
    2. Under **Keys & OAuth**, you'll find your app's OAuth settings.
    3. In the **Redirect URIs** section, add the following URL: `https://api.nango.dev/oauth/callback`.
    4. Save your changes.
  </Step>
  <Step title="Obtain API credentials">
    1. Still in the **Keys & OAuth** section, locate your app's credentials.
  ...
  <Step title="Create a development/sandbox account for testing">
    ...
    1. From your Developer Dashboard, go to **Sandbox** > **Create a sandbox company**.
...
QuickBooks requires a company ID/realmId for each API request. Nango automatically retrieves this for you during the OAuth flow, or you can manually override it by specifying the realmId when creating a new connection.

```js
nango.auth('quickbooks', '<CONNECTION-ID>', {connectionConfig: {realmId: '<REALM-ID>'}});
```
