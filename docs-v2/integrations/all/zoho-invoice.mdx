...
description: 'Access the Zoho Invoice API in 2 minutes 💨'
---
  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Authorize Zoho Invoice">
        Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then log in to Zoho Invoice. Later, you'll let your users do the same directly from your app.
      </Step>
