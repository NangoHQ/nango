...
<Steps>
  ...
  <Step title="Enable the APIs you need">
    ...
    2. Search for **YouTube API** and select and select the ones you wish to integrate with, such as **Youtube Analytics API**, **Youtube Reporting API**, etc., then click **Enable** for each.
  </Step>
