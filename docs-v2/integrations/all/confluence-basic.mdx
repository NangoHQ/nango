...
<Steps>
  <Step title="Create an Atlassian account">
    If you don't already have one, sign up for an [Atlassian account](https://id.atlassian.com/signup/).
  </Step>
  ...
  <Step title="Next">
    Follow the [_Quickstart_](/getting-started/quickstart) using:
