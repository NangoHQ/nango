  ...
  <Tab title="🚀 Quickstart">
    ...
    <Steps>
      ...
      <Step title="Prepare your URIs">
        ...
        - **install_uri**: Your application's setup page URL. To satisfy Aircall's requirement, you can provide a link that shows users what the app is about. This is necessary only if you are initiating the authorization flow outside Nango; since you are initiating it within Nango, it is not required.
