  ...
  <Tab title="🚀 Quickstart">
    ...
    <Steps>
      <Step title="Create a partner-specific account">
        You can create a partner-specific account by signing up at [https://aircall.io/partners/technology/signup/](https://aircall.io/partners/technology/signup/).
      </Step>
      <Step title="Prepare your URIs">
        ...
        - **install_uri**: Your application's installation/setup page URL
      ...
      <Step title="Request OAuth credentials">
        ...
        3. Aircall will reply with your **Client ID** and **Client Secret** once approved.
      </Step>
      <Step title="Next">
