...
#### Step 1: Finding Your Atlassian Domain and Atlassian API Key
...
3. Your Atlassian Domain is available in the browser search bar
...
<img src="/integrations/all/jira-basic/nango_connect_ui.png" />
...
<Card title="Connect to jira-basic" icon="link" href="/integrations/all/jira-basic/connect" horizontal>
  Guide to connect to jira-basic using Connect UI
</Card>
