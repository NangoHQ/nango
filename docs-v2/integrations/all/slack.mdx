  ...
  <Tab title="🧑‍💻 OAuth app setup">
    <Steps>
      ...
      <Step title="Create & configure a Slack app">
        ...
        - User token Scopes access user data and act on behalf of users that authorize them. They will be [added](http://localhost:3033/reference/api/connect/sessions/create#body-integrations-config-defaults-key-user-scopes) to Nango when creating a Slack connection.
      </Step>
