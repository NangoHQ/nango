...
API configuration: [`docusign`](https://nango.dev/providers.yaml), [`docusign-sandbox`](https://nango.dev/providers.yaml)
...
- Note that when creating your app, the `integration key` in docusign is the `client id`. Additionally when creating your app, you need to add a secret key.
