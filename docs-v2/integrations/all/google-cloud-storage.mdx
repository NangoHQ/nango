  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      <Step title="Create an integration">
        In Nango ([free signup](https://app.nango.dev)), go to [Integrations](https://app.nango.dev/dev/integrations) -> _Configure New Integration_ -> _Google Cloud Storage_.
      ...
      <Step title="Call the Google Cloud Storage API">
        Let's make your first request to the Google Cloud Storage API (list buckets). Replace the placeholders below with your [secret key](https://app.nango.dev/dev/environment-settings), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections):
        <Tabs>
            <Tab title="cURL">

                ```bash
                curl "https://api.nango.dev/proxy/storage/v1/b" \
  ...
  <Tab title="🧑‍💻 OAuth app setup">
    ...
    <Steps>
      ...
      <Step title="Verify your app">
        Most Google Cloud Storage scopes are marked "sensitive" by Google. You need to pass a Google review to go live.
