...
6. Save and securely store the Token ID and Token Secret
...
<Tip>
For detailed permission setup, refer to the [Netsuite Token-Based Authentication Setup Guide](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/section_157771239605.html).
</Tip>
