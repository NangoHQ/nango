...
description: 'Access the Google Ads API in 2 minutes 💨'
---
...
<Tabs>
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Authorize Google Ads">
        Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then log in to Google Ads. Later, you'll let your users do the same directly from your app.
      </Step>
      <Step title="Call the Google Ads API">
        Let's make your first request to the Google Ads API to fetch your profile information. This request will return basic details about the authenticated user, such as their email address and message/thread counts. Replace the placeholders below with your [secret key](https://app.nango.dev/dev/environment-settings), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections):
        <Tabs>
            <Tab title="cURL">
  ...
  <Tab title="🧑‍💻 OAuth app setup">
    ...
    <Steps>
      ...
      <Step title="Verify your app">
       Most Google Ads scopes are marked "restricted" by Google.
  ...
  | `https://mail.google.com/` | Read, compose, send, and permanently delete all emails from Google Ads |
  ...
  <Tab title="🔗 Useful links">
    ...
    | | [Google Analytics API](https://developers.google.com/google-ads/api/reference/rpc/v21/overview) |
  ...
  <Tab title="🚨 API gotchas">
    ...
    <Note>Contribute API gotchas by [editing this page](https://github.com/nangohq/nango/tree/master/docs-v2/integrations/all/google-ads.mdx)</Note>
  </Tab>
</Tabs>
