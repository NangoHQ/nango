  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Authorize Hubspot">
        Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then login in to Hubspot. Later, you'll let your users do the same directly from your app. 
      </Step>
      <Step title="Call the Hubspot API">
        ...
        <Tabs>
            <Tab title="cURL">
                ...
                ```bash
                curl "https://api.nango.dev/proxy/crm/v3/objects/contacts" \
                  --data-urlencode "properties=email,phone" \
    ...
    <Tip>
    Next steps: 
    - [Embed the auth flow](/getting-started/quickstart/embed-in-your-app) in your app to let your users connect their HubSpot accounts
