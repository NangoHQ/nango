---
title: OpenAI Admin - How to Connect Your Account
sidebarTitle: OpenAI-Admin
---

# Overview

To connect your **OpenAI** account, you need to authenticate using an **Admin Key**. 
This key allows you to access OpenAI's APIs for programmatic administration of your account, and more.
...
3. Click **Create new Admin key** to generate a new Admin key.
   ...
   <img src="/integrations/all/openai/openai_admin.png" />
...
2. Enter your Admin key in the **Admin Key** field.
   <img src="/integrations/all/openai/openai_form.png" />
