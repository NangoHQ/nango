...
API configuration: [`sharepoint-online`](https://nango.dev/providers.yaml)
...
-   [Web API docs (their REST API)](https://learn.microsoft.com/en-us/graph/api/resources/sharepoint?view=graph-rest-1.0)
