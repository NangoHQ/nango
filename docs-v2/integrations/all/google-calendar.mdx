...
<Tabs>
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Authorize Google Calendar">
        Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then login in to Google Calendar. Later, you'll let your users do the same directly from your app. 
      </Step>
      <Step title="Call the Google Calendar API">
        ...
        <Tabs>
            <Tab title="cURL">
                ...
                ```bash
                curl "https://api.nango.dev/proxy/calendar/v3/users/me/calendarList" \
    ...
    <Tip>
    Next steps: 
    - [Embed the auth flow](/getting-started/quickstart/embed-in-your-app) in your app to let your users connect their Google Calendar accounts
  ...
  <Tab title="🔗 Useful links">
    | Topic | Links | 
    | - | - | 
    | General | [Website](https://calendar.google.com/) |
    | | [Create a test account](https://accounts.google.com/signup) |
    | Developer | [API documentation](https://developers.google.com/calendar/api) |
    | | [Create a developer account](https://console.cloud.google.com/) |
    | | [Developer console](https://console.cloud.google.com/) |
    | | [Authorization documentation](https://developers.google.com/calendar/api/guides/auth) |
    | | [Register an OAuth app](https://console.cloud.google.com/apis/credentials) |
    | | [List of OAuth scopes](https://developers.google.com/calendar/api/guides/auth#scopes) |
    | | [Details on rate limits](https://developers.google.com/calendar/api/limits) |
