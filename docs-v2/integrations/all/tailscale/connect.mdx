...
1. **Organization Name** - The unique identifier for your organization.
...
1. Log in to your Tailscale admin console at [admin.tailscale.com](https://admin.tailscale.com).
...
1. In the Tailscale admin console, navigate to the [OAuth clients page](https://login.tailscale.com/admin/settings/keys).
...
Once you have both your **Organization Name**, **Client ID** and **Client secret**:
