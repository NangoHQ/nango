...
Important: Store this token securely and never share it. It provides the same access as your password.

Note: As of March 13, 2024, API tokens have a maximum lifespan of 1 year.
