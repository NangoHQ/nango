...
4. **Downloading Content**: When downloading content from Google Drive, do not use the `fetch-document` action. Instead, use the [Nango proxy for downloading content](https://docs.nango.dev/guides/proxy-requests#proxy-requests).
