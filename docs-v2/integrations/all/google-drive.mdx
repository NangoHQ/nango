...
4. Configure Nango webhooks:
    ...
    <img src="google-drive/webhook-url.png" alt="Nango Environment Settings page showing webhook URL configuration" />

5. Access the sample app:
    - Open [http://localhost:3011](http://localhost:3011/)
    - Click on "Files" to start the Google Drive integration

    <img src="google-drive/sample-app-home.png" alt="Sample app home page with Files section highlighted" />
...
6. Connect your Google Drive account:
    ...
    <img src="google-drive/connect-popup.png" alt="Connect popup with Google Drive account options" />

    <img src="google-drive/success-popup.png" alt="Successfully connected to Google Drive" />
...
7. Select the files and folders you want to sync:
    ...
    <img src="google-drive/select-files.png" alt="Select files and folders from Google Drive" />

8. The files and folders will be synced to your Nango account and displayed in the UI.

    <img src="google-drive/synced-files.png" alt="Synced files and folders in the UI" />
...
10. Disconnect your Google Drive account:
    ...
    <img src="google-drive/disconnect-button.png" alt="Disconnect popup with Google Drive account options" />
...
2. **File Syncing**
   ...
   <img src="google-drive/sync-status.png" alt="Nango dashboard showing sync status and file list" />
