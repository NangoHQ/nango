...
- You must set have an Auth0 account.
...
- This can be obtaned from the **Identifier** field on your recently created app, **APIs** tab.
<img src="/integrations/all/auth0-cc/audience.png" />
#### Step 4: Finding Your Organization
- <Tip>This is optional and can be obtained from the Organizations page if your tenant is configured to use Organizations.</Tip>
