...
<Steps>
  ...
  <Step title="Configure OAuth scopes">
    When setting up your integration in Nango, you'll need to specify the scopes your application requires. Zendesk supports the following common scopes:
    - `read` - Read access to the account
    - `write` - Write access to the account
    - `impersonate` - Act on behalf of users
    
    For a complete list of scopes, refer to the [Zendesk OAuth documentation](https://support.zendesk.com/hc/en-us/articles/4408845965210#topic_gql_kbd_gt).
  </Step>
...
| | [OAuth authentication guide](https://support.zendesk.com/hc/en-us/articles/4408845965210-Using-OAuth-authentication-with-your-application) |
...
| | [OAuth scopes](https://support.zendesk.com/hc/en-us/articles/4408845965210#topic_gql_kbd_gt) |
...
| | [API rate limits](https://developer.zendesk.com/api-reference/ticketing/introduction/#rate-limits) |
...
-   Zendesk has [rate limits](https://developer.zendesk.com/api-reference/ticketing/introduction/#rate-limits) that vary by plan. The default is 700 requests per minute.
