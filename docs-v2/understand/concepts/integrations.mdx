...
Creating an integration is straightforward and only takes a few clicks in the [Nango UI](/understand/concepts/ui). Whether for GitHub, Slack, or any other service, you'll set up one integration per service.
