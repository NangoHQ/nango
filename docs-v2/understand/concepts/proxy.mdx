...
- **Rate-limit Management:** Handles rate limits with smart retries ([step-by-step guide](/guides/customize/handle-rate-limits)).
...
Check out the Proxy [step-by-step guide](/guides/proxy-requests-to-an-api) or refer to the reference ([API](/reference/api/proxy/get) / [SDK](/reference/sdks/node#proxy)) for full details on proxy options.
