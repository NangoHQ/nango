...
The `fetchData` function starts on the schedule indicated in your [integration configuration](TODO BB). The `ResponseModel` is configurable via the integration configuration and is auto-imported into your script.
