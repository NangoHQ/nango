...
Both execution models have different tradeoffs.
...
<table>
  ...
  <tr>
    ...
    <td>
      <ul>
        <li>Handles rate limits & retries automatically</li>
...
1. [Setup webhooks from Nango to your app](/implementation-guides/platform/webhooks-from-nango)
