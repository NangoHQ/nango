...
The easiest way to let your users authorize an external API is with Nango’s pre-built **Connect UI**. Depending on your [plan](https://www.nango.dev/pricing), you can also customize your brand color and remove the _Secured by Nango_ watermark.
