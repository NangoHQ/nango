...
Nango has off-the-shelf support for webhooks coming from [this list of APIs](/integrate/guides/receive-webhooks-from-an-api#apis-with-out-of-the-box-webhook-support).
...
# APIs with out-of-the-box webhook support
...
<Info>
The Nango platform makes it easy to support external webhooks from new APIs with minimal changes. Just request it in the [community](https://nango.dev/slack).
</Info>
