...
```json
{
    ...
    "updatedAfter": "<timestamp>" // Null on the sync's first execution.
}
```
...
Each record contains useful metadata, including the cursor that you used to fetch the latest updates. 
