...
Nango stores this metadata in the [Connection](/core-concepts#connections) objects. You can retrieve it with the [SDKs](/sdks) or [API](/api).

## Configure integrations programmatically

Read the [API reference](/api) to programmatically manage [Integrations](/core-concepts#integrations).
