...
Nango Auth lets you get access to external APIs with OAuth & API keys, on behalf of users. It works in isolation and seamlessly integrates with [Nango Sync](/nango-sync).
