...
| Endpoint | Description | Readme |
| - | - | - |
| `GET /tables` | Lists all tables with their schema for all bases with a reference to the base id that<br />the table belongs to | [🔗](https://github.com/NangoHQ/integration-templates/blob/main/integrations/airtable/actions/tables.md) |
| `GET /bases` | List all bases | [🔗](https://github.com/NangoHQ/integration-templates/blob/main/integrations/airtable/actions/bases.md) |
</Accordion>
