...
| Endpoint | Description | Readme |
| - | - | - |
| `GET /tables` | Lists all tables with their schema for all bases with a reference to the base id that<br />the table belongs to<br /> | [🔗](https://github.com/NangoHQ/integration-templates/blob/main/integrations/airtable/syncs/tables.md) |
