...
| `GET /events` | Sync calendar events on the primary calendar going back one month and<br />save the entire object as specified by the Outlook Calendar API | [🔗](https://github.com/NangoHQ/integration-templates/blob/main/integrations/outlook/syncs/events.md) |
