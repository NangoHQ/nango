...
| Endpoint | Description | Readme |
| - | - | - |
| `GET /fetch-folders` | Fetches the content of a folder given its ID. The output is a<br />list of folders within the specified folder if an id is provided.<br />If no id is provided, the output is a list of folders at the root level. | [🔗](https://github.com/NangoHQ/integration-templates/blob/main/integrations/google-drive/actions/fetch-folders.md) |
