...
You can activate template integrations directly in the Nango UI to get started fast. But if you want to edit their code or configuration, you must pull them in your [integrations folder](/understand/concepts/integrations-folder) as described below.
