...
If you want to contribute a new API yourself, follow the steps below.
...
<Tip>
Learn more: [understand API configurations](/understand/concepts/api-configuration), [reference](/reference/api-configuration), [all existing API configurations](https://nango.dev/providers.yaml).
</Tip>
...
Add a `<api>.mdx` file (e.g. `github.mdx`) for you API to the `docs-v2/integrations/all` folder. Check out [other examples](https://docs.nango.dev/integrations) to fill out the content of the documentation page.
