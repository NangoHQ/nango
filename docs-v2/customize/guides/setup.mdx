...
Set up the [Nango CLI](/understand/concepts/cli) and an [integration folder](/understand/concepts/integrations-folder) to develop custom integrations with Nango.
...
Learn more about the [Nango CLI](/understand/concepts/cli) ([reference](/reference/cli)) and the content of the [integrations folder](/understand/concepts/integrations-folder).
