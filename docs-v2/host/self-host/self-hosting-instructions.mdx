...
Nango Connect is an aditionnal UI that you can your customers can use to easily connect to integration. [See related documentation](/guides/getting-started/authorize-an-api-from-your-app#authorize-users-from-your-app).
