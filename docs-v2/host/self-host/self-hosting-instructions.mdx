...
Nango Connect is an aditionnal UI that you can your customers can use to easily connect to integration. [See related documentation](/integrate/guides/authorize-an-api#authorize-users-from-your-app).
