...
<Note>Your should read the [self-hosting instructions](/nango-deploy/oss-instructions) before deploying to production.</Note>
<Warning>This page is out-of-date since the release of Nango's syncing features. Reach out on the [community](https://nango.dev/slack) if you want help to self-host the latest Nango version.</Warning>
