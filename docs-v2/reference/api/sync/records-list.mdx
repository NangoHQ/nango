...
## The `updated_after` parameter & webhooks

If you are receiving the webhooks from Nango ([step-by-step guide](/integrate/guides/receive-webhooks-from-nango)), you can use the timestamp you get from the webhook for the `updated_after` parameter.
