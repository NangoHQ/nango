...
Makes an HTTP GET request inside an integration script.
...
Makes an HTTP POST request inside an integration script.
...
Makes an HTTP PUT request inside an integration script.
...
Makes an HTTP PATCH request inside an integration script.
...
Makes an HTTP DELETE request inside an integration script.
