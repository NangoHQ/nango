...
Read more about [integration functions](/guides/platform/functions) to understand what role they play in Nango.
...
Sync scripts persist data updates to the Nango cache, which your app later fetches (cf. [step-by-step guide](/implementation-guides/syncs/implement-a-sync)).
