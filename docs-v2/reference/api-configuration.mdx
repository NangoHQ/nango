...
<ResponseField name="auth_mode" type="string" >
    The authentication mode. Must be one of: "API_KEY", "APP", "APP_STORE", "BASIC", "NONE", "OAUTH1", "OAUTH2", "OAUTH2_CC", "CUSTOM", "TBA", "TABLEAU", "JWT", "BILL", "TWO_STEP", "SIGNATURE_BASED".
</ResponseField>
...
<ResponseField name="webhook_routing_script" type="array">
    Specifies a script to handle external [webhooks](/understand/concepts/webhooks).
</ResponseField>
