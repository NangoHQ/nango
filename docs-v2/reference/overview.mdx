...
<CardGroup cols={2}>
    ...
    <Card title="providers.yaml" href="/reference/api-configuration" icon="network-wired" color="#F7D300">
        How external APIs are configured on Nango.
    </Card>
    <Card title="nango.yaml" href="/reference/integration-configuration" icon="arrow-right-arrow-left" color="#F7D300">
