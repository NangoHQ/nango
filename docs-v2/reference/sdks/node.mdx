  ...
  <ResponseField name="config" type="object" required>
    <Expandable title="config" defaultOpen>
      ...
      <ResponseField name="delta" type="string">
        DEPRECATED (use updatedAfter) Timestamp, e.g. 2023-05-31T11:46:13.390Z. If passed, only records modified after this timestamp are returned, otherwise all records are returned.
      </ResponseField>
    </Expandable>
  </ResponseField>
</Expandable>
