...
Makes an HTTP GET request using the [proxy](/understand/concepts/proxy).
...
Makes an HTTP POST request using the [proxy](/understand/concepts/proxy).
...
Makes an HTTP PUT request using the [proxy](/understand/concepts/proxy).
...
Makes an HTTP PATCH request using the [proxy](/understand/concepts/proxy).
...
Makes an HTTP DELETE request using the [proxy](/understand/concepts/proxy).
