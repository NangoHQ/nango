...
<Expandable>
  ...
  <ResponseField name="detectClosedAuthWindow" type="boolean" default="true">
    Control OAuth popup close detection. If set to false a closed popup will not be detected as a failed authorization
  </ResponseField>
</Expandable>
