...
You can handle these errors in your code using the `AuthErrorV2` class.

```ts
import { AuthErrorV2 } from '@nangohq/frontend';
...
try {
    ...
    if (error instanceof AuthErrorV2 && error.type === '<error_type>') {
