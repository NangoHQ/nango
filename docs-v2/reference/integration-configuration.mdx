  ...
  asana: # Integration ID.
    syncs:
      asana-fetch-tasks: # Sync name.
        ...
        endpoint: GET /asana/asana-tasks # Generated endpoint to access the synced model.
        ...
        track_delete: true # If true, automatically detects deleted records (for full refresh syncs only).
    ...
    actions:
      asana-create-task:
        ...
        endpoint: POST /asana/asana-tasks # Generated endpoint to trigger to action.
...
<ResponseField name="track_delete" type="boolean">
