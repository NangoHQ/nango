...
- **API rate limit of 2,400 requests per minute:** This includes all requests made from both your applications and scripts combined. If the rate limit is exceeded, check the standard rate-limit headers to know when to resume API requests. This rate limit can be increased for paying customers.
