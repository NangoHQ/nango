...
const res = await nango.proxy({
    ...
    Feel free to contribuge the `proxy.base_url` field to any API in the [providers.yaml](https://nango.dev/providers.yaml) public file, or reach out on the [Slack community](https://www.nango.dev/slack) to ask us to do it.
</Info>
</Tab>
