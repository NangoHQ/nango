...
If you want to continuously sync data from the external API, check out [syncs](/guides/sync). If you find yourself using too many Proxy requests for a single workflow, checkout [actions](/guides/action).
