...
Check out the syncs [step-by-step guide](/guides/getting-started/read-from-an-api) or refer to the reference ([API](/reference/api/sync/records-list) / [SDK](/reference/sdks/node#syncs)).
