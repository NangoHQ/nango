...
Inside your scripts, Nango is caching the credentials for a duration of 60seconds to reduce latency. After that period, if needed, we will query our API again to get updated credentials.
