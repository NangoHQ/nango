...
3.  **Define Containers:** Create one task definition for *each* Nango service (Server, Jobs, Persist, Orchestrator, Runner), configuring the container settings within each:
    ...
    * **Nango Server Container:**
        ...
        * **Environment Variables (in additions to the shared ones):**
            ...
            * `SMTP_HOST`: The url of your SMTP server (ex: `email-smtp.us-west-1.amazonaws.com`)
            * `SMTP_PORT`: The port of your SMTP server (ex: `465`)
            * `SMTP_SECURE`: `true` if your SMTP server supports TLS, `false` otherwise
            * `SMTP_USER`: The user to authenticate to your SMTP server
            * `SMTP_PASSWORD`: The password to authenticate to your SMTP server
            ...
            "containerDefinitions": [
                {
                    ...
                    "environment": [
                        ...
                        {
                            "name": "SMTP_HOST"
                            "value": "YOUR_SMTP_SERVER_HOST"
                        },
                        {
                            "name": "SMTP_PORT"
                            "value": "YOUR_SMTP_SERVER_PORT"
                        },
                        {
                            "name": "SMTP_SECURE"
                            "value": "true"
                        ...
                        {
                            "name": "SMTP_USER"
                            "value": "YOUR_SMTP_SERVER_USER"
                        },
                        {
                            "name": "SMTP_PASSWORD"
                            "value": "YOUR_SMTP_SERVER_PASSWORD"
                        },
