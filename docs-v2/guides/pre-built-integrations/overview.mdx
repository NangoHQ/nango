...
- **Actions:** to perform specific tasks synchronously, such as sending a Slack message or updating data ([overview](/guides/actions/overview), [guides](/guides/syncs/use-an-action)).
