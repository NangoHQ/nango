...
<Info>
This feature is available on Growth plans as a paid add-on, and on Enterprise plans. Reach out on your Slack Connect channel or the [community](https://nango.dev/slack) to enable it.
</Info>
