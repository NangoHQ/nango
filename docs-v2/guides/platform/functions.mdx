...
Functions run in Nango's infrastructure and give you deep control over your [Syncs](/guides/use-cases/syncs), [Actions](/guides/use-cases/actions), or [Webhooks processing](/guides/use-cases/webhooks).

They typically cover:
- External API requests
- Data transformation
- [Customer-specific logic](/guides/platform/customer-configuration) (field mappings, filter options, etc.)
- Other business logic about how you read & write data from external APIs
...
- The code of your Functions is stored in a `nango-integrations` folder in your code base (e.g. in your monorepo)
...
- All inputs & outputs of Functions are strictly typed
