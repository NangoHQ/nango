...
<CardGroup cols={3}>
  ...
  <Card title="Lever" href="/integration-templates/lever" icon="briefcase">
    Sync Lever opportunities, applications, feedback, interviews, notes and offers for a specific opportunity. Postings and questions for a specific job posting. Actions to create; a note for a specific opportunity and an opportunity.
  </Card>
