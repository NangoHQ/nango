...
Nango lets you build **any** integration with [the 100+ APIs it supports](/integrations/overview).
...
As the community and Nango grow, we expect to have hundreds of templates and use-cases for hundreds of APIs available for you.
...
<CardGroup cols={3}>
    <Card title="Slack" href="/integration-templates/slack" icon="slack">
        Syncs Slack users, channels, messages and reactions
    </Card>
</CardGroup>
