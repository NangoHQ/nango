...
<Info>
Pre-requisite: set up the Nango CLI & `nango-integration` folder (cf. [Sync Data Guide - Step 1](/guides/sync#step-1-setup-the-nango-cli-and-nango-integrations-folder))
</Info>
...
2. Optionally, extend and customize the template to your needs (cf. [Sync Data Guide](/guide/sync)).
