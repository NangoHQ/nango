...
The SDK will parse the cursor from the header and include a `next_cursor` property as part of the response.
This value can be used with the `cursor` parameter to get the next page of results.
