...
Nango is open-source because we believe the best platforms are built by communities.

We see Nango as an open platform that lets you easily integrate your software with other software your customer's use.

Contribute support for more APIs and help shape the future of Nango:
...
- Ask questions abou Nango & external APIs on the [Slack community](https://www.nango.dev/slack)
