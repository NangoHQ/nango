...
Nango aims provides [common infrastructure](/core-concepts#nango-infrastructure) to accelerate integration development, without limiting the ability to build many complex integrations. To achieve this, we let developers define their own API requests & models, with the assistance of our tooling.
