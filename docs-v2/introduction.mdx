...
We built the [hard infrastructure](core-concepts#infra), so you don't have to.
...
Nango works with **any** API and use-case. Adding [Integration Templates](/core-concepts#templates) is easy and we already have the main APIs covered.
