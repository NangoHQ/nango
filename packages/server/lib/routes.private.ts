...
import { getBillingUsageTopValues } from './controllers/v1/plans/usage/getBillingUsageTopValues.js';
...
web.route('/plans/billing-usage/top-values').get(webAuth, getBillingUsageTopValues);
