...
import { postFunctionDeploy } from './controllers/functions/deploy/postDeploy.js';
...
publicAPI.route('/functions/deploy').post(apiAuth, withScope('environment:deploy'), postFunctionDeploy); // TODO: add Audit
