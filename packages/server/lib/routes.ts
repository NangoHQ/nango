...
app.route('/connection/metadata/bulk').post(apiAuth, connectionController.bulkSetMetadata.bind(connectionController));
app.route('/connection/metadata/bulk').patch(apiAuth, connectionController.bulkUpdateMetadata.bind(connectionController));
