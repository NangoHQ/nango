...
app.route('/connection/metadata').post(apiAuth, connectionController.setMetadata.bind(connectionController));
app.route('/connection/metadata').patch(apiAuth, connectionController.updateMetadata.bind(connectionController));
