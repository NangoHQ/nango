...
app.route('/connection/bulk/metadata').post(apiAuth, connectionController.bulkSetMetadata.bind(connectionController));
app.route('/connection/bulk/metadata').patch(apiAuth, connectionController.bulkUpdateMetadata.bind(connectionController));
