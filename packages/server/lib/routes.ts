...
import { cliVersionCheck } from './middleware/cliVersionCheck.js';
...
publicAPI.route('/sync/deploy').post(apiAuth, cliVersionCheck('0.42.21'), postDeploy);
publicAPI.route('/sync/deploy/confirmation').post(apiAuth, cliVersionCheck('0.42.21'), postDeployConfirmation);
