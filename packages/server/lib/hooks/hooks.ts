...
import type { TbaCredentials, IntegrationConfig, DBEnvironment, Provider, JwtCredentials, SignatureBasedCredentials } from '@nangohq/types';
...
export const connectionTest = async (
    providerName: string,
    provider: Provider,
    credentials: ApiKeyCredentials | BasicApiCredentials | TbaCredentials | JwtCredentials | SignatureBasedCredentials,
    connectionId: string,
