...
import type { TbaCredentials, IntegrationConfig, DBEnvironment, Provider, GhostAdminCredentials } from '@nangohq/types';
...
export const connectionTest = async (
    providerName: string,
    provider: Provider,
    credentials: ApiKeyCredentials | BasicApiCredentials | TbaCredentials | GhostAdminCredentials,
    connectionId: string,
