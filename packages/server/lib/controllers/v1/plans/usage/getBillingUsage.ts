...
const breakdownFields = {
    ...
    function_duration_seconds: z.enum(BREAKDOWN_DIMENSIONS.function_duration_seconds).optional(),
...
const filterFields = {
    ...
    function_duration_seconds: parseFilter(BREAKDOWN_DIMENSIONS.function_duration_seconds).optional(),
