import { configService, flowService, listDeployedFunctionsMeta } from '@nangohq/shared';
...
export const getIntegrationTemplates = asyncWrapper<GetIntegrationTemplates>(async (req, res) => {
    ...
    const deployedRows = await listDeployedFunctionsMeta({ environmentId: environment.id, providerConfigKey });
