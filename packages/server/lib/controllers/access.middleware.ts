...
import { LogActionEnum, environmentService, isCloud, setAccount, setEnvironmentId, isBasicAuthEnabled, errorManager, userService } from '@nangohq/shared';
...
export class AccessMiddleware {
    ...
    async publicKeyAuth(req: Request, res: Response, next: NextFunction) {
        ...
        try {
            ...
            errorManager.report(e, { source: 'platform', operation: LogActionEnum.INTERNAL_AUTHORIZATION });
            return errorManager.errRes(res, 'unknown_account');
        }
