...
export const postControlPlaneMcp = asyncWrapperWithEnvironment<PostControlPlaneMcp>(async (req, res) => {
...
export const getControlPlaneMcp = asyncWrapperWithEnvironment<GetControlPlaneMcp>((_, res) => {
