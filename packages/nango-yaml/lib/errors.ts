...
export class ParserErrorTypeSyntax extends ParserError {
    constructor(options: { value: string; path: string[] }) {
        super({
            ...
            message: `Type "${options.value}" contains some unsupported typescript syntax, please use allowed syntax. Documentation: https://nango.dev/docs/reference/api-configuration#all-configuration-fields`,
            path: options.path
        });
    }
}
