...
export async function routeSync(args: InitialSyncArgs): Promise<boolean | object | string> {
...
export async function scheduleAndRouteSync(args: ContinuousSyncArgs): Promise<boolean | object | string> {
