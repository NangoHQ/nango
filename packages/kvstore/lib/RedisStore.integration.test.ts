...
describe('RedisKVStore', () => {
    ...
    describe('setIfValueEquals', () => {
        ...
        it('many concurrent same-owner refreshes all succeed (Lua atomicity)', async () => {
        ...
        it('concurrent wrong-owner refreshes never overwrite the holder', async () => {
    ...
    describe('deleteIfValueEquals', () => {
        ...
        it('at most one concurrent delete succeeds for the same value (Lua atomicity)', async () => {
        ...
        it('concurrent wrong-owner deletes never remove the key', async () => {
