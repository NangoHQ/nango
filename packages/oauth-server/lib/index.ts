export {
    ...
    revokeOAuthGrantByHash,
    revokeOAuthGrantByHashInTransaction,
    revokeOAuthSessionsBySubjectInTransaction
} from './adapter.js';
...
export type {
    ...
    OAuthGrantRevocationCompletion,
    OAuthGrantRevocationOutcome,
    OAuthGrantRevocationRequest,
    OAuthResourceConfig
} from './provider.js';
