...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
    return (
        <input
            ...
            className={cn(
                'bg-background-surface border border-border-muted text-text-primary placeholder:text-text-tertiary focus-shadow focus:border-border-default data-[filled=true]:not-aria-invalid:border-border-strong',
