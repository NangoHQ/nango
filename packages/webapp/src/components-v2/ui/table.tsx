...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
    return (
        <th
            ...
            className={cn(
                'h-11 px-2 text-left align-middle font-semibold whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
                className
            )}
            {...props}
        />
...
function TableCell({ className, ...props }: React.ComponentProps<'td'>) {
    return (
        <td
            ...
            className={cn('px-6 py-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]', className)}
            {...props}
        />
    );
}
...
function TableCaption({ className, ...props }: React.ComponentProps<'caption'>) {
    return <caption data-slot="table-caption" className={cn('text-text-tertiary mt-4 text-s', className)} {...props} />;
}
