                    ...
                    <>
                        <div className="flex gap-1.5">
                            ...
                            <Link
                                ...
                                target="_blank"
                                to="https://nango.dev/docs/guides/auth/auth-guide#2-create-an-integration"
                            >
                        ...
                        <Alert variant="info">
                            ...
                            <AlertDescription>
                                <span>
                                    ...
                                    <StyledLink
                                        to="https://nango.dev/docs/guides/auth/auth-guide#5-setup-a-custom-oauth-callback-url-optional"
                                        type="external"
                                        variant="info"
                                    >
                                        docs
