        ...
        <SettingsContent title="General">
            <SettingsGroup label="Environment name">
                <EditableInput
                    ...
                    editInfo={
                        <>
                            <span className="text-text-tertiary text-s -mt-4">&#42;Must be lowercase letters, numbers, underscores and/or dashes.</span>
                                ...
                                <Alert variant="info">
                                    ...
                                    <AlertDescription>
                                        ...
                                        <code className="font-mono text-sm font-semibold">
                                            NANGO_SECRET_KEY_DEV={env.toUpperCase()}={'<secret-key>'}
                                        </code>
                                        .
                                    </AlertDescription>
                                </Alert>
            ...
            <SettingsGroup label="Environment suppression" className="items-center">
                <div>
                    {/* This produces 2 levels of buttons */}
                    <DeleteButton
                        environmentName={env}
