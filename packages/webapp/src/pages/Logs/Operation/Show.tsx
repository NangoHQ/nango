    ...
    if (loading) {
        return (
            <div className="py-6 px-6 flex flex-col gap-9">
                <h3 className="text-xl font-semibold text-text-primary flex gap-4 items-center">Operation Details</h3>
        ...
        <div className="py-8 px-6 flex flex-col gap-5 h-screen">
            <header className="flex gap-2 flex-col border-b border-b-gray-400 pb-5">
                <div className="flex justify-between items-center">
                    <h3 className="text-xl font-semibold text-text-primary">Operation Details</h3>
                    <div className="mr-9">
            ...
            <div className="flex gap-3 flex-wrap items-center">
                <div className="flex gap-2 items-center max-w-[30%]">
                    ...
                    <div className="text-text-tertiary text-s font-code truncate">
                        {operation.integrationName ? (
                            <Link
                                to={`/${env}/integrations/${operation.integrationName}`}
                                target="_blank"
                                className="flex gap-2.5 items-center hover:text-text-primary"
                            >
                ...
                <div className="flex gap-2 items-center max-w-[30%]">
                    ...
                    <div className="text-text-tertiary text-s pt-px truncate">{operation.syncConfigName ? operation.syncConfigName : 'n/a'}</div>
                </div>
            </div>
            <div className="">
                <h4 className="font-semibold text-sm mb-2">Payload</h4>
                {payload ? (
                    <div
                        className="text-text-tertiary text-sm bg-bg-subtle py-2 resize-y overflow-auto"
                        style={{
                            minHeight: '100px',
                            height: '30vh',
                            maxHeight: '60vh',
