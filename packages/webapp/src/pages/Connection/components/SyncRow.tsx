                                                        ...
                                                        <DialogDescription>
                                                            {triggerMode === 'incremental' ? (
                                                                <>
                                                                    ...
                                                                    <Link
                                                                        to="https://nango.dev/docs/implementation-guides/syncs/large-datasets#incremental-syncing"
                                                                        className="underline"
                                                                    >
                                                                        Learn more
                                                                    </Link>
                                                                ...
                                                                <>
                                                                    ...
                                                                    <Link
                                                                        to="https://nango.dev/docs/implementation-guides/syncs/large-datasets#full-refresh-syncing-small-datasets-only"
                                                                        className="underline"
                                                                    >
                                                                        Learn more
                                                                    </Link>{' '}
