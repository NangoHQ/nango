        ...
        <DashboardLayout selectedItem={LeftNavBarItems.Integrations}>
            {integrations && !!integrations.length && (
                <div className="">
                    ...
                    <div className="h-fit min-w-fit border border-border-gray rounded-md text-white text-sm">
