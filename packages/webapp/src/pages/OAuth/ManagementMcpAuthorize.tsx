                ...
                <div className="flex flex-col gap-6 w-full">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-1 min-w-0">
                            <span className="text-body-medium-semi text-text-strong">Read logs in accessible environments</span>
                            <span className="text-body-small-regular text-text-muted break-words">
                                The environment is selected in the MCP URL and access returns to {details.data.client.redirectHost}.
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <Button variant="primary" size="lg" onClick={() => approve.mutate()} loading={approve.isPending} disabled={deny.isPending}>
                            Authorize
                        </Button>
                    </div>
                </div>
