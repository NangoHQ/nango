 ...
 */
// Roughly a 14-inch MacBook Pro's content width, so an external monitor shows the same layout most
// of the team reads the page at rather than a stretched one.
export const CENTERED_MAX_WIDTH = 'max-w-[1288px]';
