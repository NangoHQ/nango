            ...
            >
                ...
                {showCloseButton && (
                    <DialogPrimitive.Close
                        ...
                        className="text-text-secondary hover:text-text-strong focus-default transition-colors cursor-pointer absolute top-4 right-4 rounded-xs disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
                    >
                        <XIcon />
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
    return <DialogPrimitive.Title data-slot="dialog-title" className={cn('text-lg leading-none font-semibold text-text-strong', className)} {...props} />;
}
