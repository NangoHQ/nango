    ...
    return (
        <input
            ...
            className={cn(
                ...
                'file:text-neutral-950  flex h-9 w-full min-w-0 rounded px-3 py-1 transition-colors focus-default file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-body-medium-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
