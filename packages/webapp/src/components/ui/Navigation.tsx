...
export const NavigationList: React.FC<React.ComponentProps<typeof TabsPrimitive.List>> = (props) => {
    return (
        <TabsPrimitive.List
            {...props}
            className={cn(
                'w-46 h-fit shrink-0 p-2 bg-surface-page rounded',
                // Horizontal
...
export const NavigationTrigger: React.FC<React.ComponentProps<typeof TabsPrimitive.Trigger>> = (props) => {
    return (
        <TabsPrimitive.Trigger
            className={cn(
                'w-full p-2.5 cursor-pointer text-text-secondary !text-body-medium-medium text-start rounded transition-colors hover:bg-surface-canvas hover:text-text-strong data-[state=active]:bg-surface-panel-inset data-[state=active]:text-text-strong focus-default',
                // Horizontal
