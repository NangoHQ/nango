    ...
    return (
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                style={insetStyle}
                className={cn(
                    'bg-surface-overlay data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-70 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
                    side === 'right' &&
                        (insetStyle
