...
function DropdownMenuItem({
    ...
    return (
        <DropdownMenuPrimitive.Item
            ...
            className={cn(
                "transition-colors focus:bg-state-hover focus:text-text-strong data-[variant=destructive]:text-status-danger-text data-[variant=destructive]:focus:bg-red-500/10 data-[variant=destructive]:focus:text-status-danger-text data-[variant=destructive]:*:[svg]:!text-destructive [&_svg:not([class*='text-'])]:text-neutral-500 relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-body-medium-medium outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:transition-colors [&_svg:not([class*='size-'])]:size-4",
                className
            )}
            {...props}
        />
