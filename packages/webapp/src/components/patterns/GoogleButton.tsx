...
export default function GoogleButton({ text, setServerErrorMessage, token }: Props) {
    ...
    return (
        <button
            onClick={googleLogin}
            type="button"
            className="flex items-center justify-center gap-2.5 p-3 bg-surface-panel text-text-primary font-roboto font-medium text-sm rounded w-full border border-border-muted"
        >
