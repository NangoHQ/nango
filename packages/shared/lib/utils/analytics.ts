...
import { isCloud, isStaging, getBaseUrl } from '@nangohq/internals/dist/environment/detection.js';
import { localhostUrl } from '@nangohq/internals/dist/environment/constants.js';
