...
describe('endUser.service', () => {
    describe('buildTagsFromEndUser', () => {
        it('should return null when no inputs provided', () => {
            expect(buildTagsFromEndUser(null, null)).toBeNull();
            expect(buildTagsFromEndUser(undefined, undefined)).toBeNull();
        });
        ...
        it('should generate all end_user fields when provided', () => {
        ...
        it('should generate all organization fields when provided', () => {
        ...
        it('should handle both endUser and organization together', () => {
        ...
        it('should combine end_user fields and end_user.tags with correct priority', () => {
