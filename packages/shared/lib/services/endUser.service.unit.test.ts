...
describe('endUser.service', () => {
    describe('buildTagsFromEndUser', () => {
        ...
        it('should generate all end_user fields when provided (normalized to lowercase)', () => {
        ...
        it('should generate all organization fields when provided (normalized to lowercase)', () => {
        ...
        it('should handle both endUser and organization together (normalized to lowercase)', () => {
        ...
        it('should combine end_user fields and end_user.tags with correct priority (normalized to lowercase)', () => {
