 ...
 * shared endpoint.
 */
export function resolveWebhookSettings(webhookSettings: DBExternalWebhook, webhookUrlOverride: string | null | undefined): DBExternalWebhook {
    const primary = webhookUrlOverride;
