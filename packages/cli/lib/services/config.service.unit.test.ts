...
describe('validate', () => {
    it('should validate empty yaml', () => {
        ...
        expect(res).toStrictEqual([
            {
                msg: 'Invalid file format, you should have at least an `integrations` property at the root level. Check our documentation https://nango.dev/docs/reference/api-configuration'
            }
        ]);
    });
