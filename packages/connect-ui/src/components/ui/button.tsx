...
const buttonVariants = cva(
    'inline-flex items-center cursor-pointer justify-center whitespace-nowrap rounded-md text-sm ring-offset-white transition-colors focus-default disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
