...
describe('Cursor', () => {
    ...
    it('should reject cursors with unexpected segments', () => {
        const malformedCursor = Buffer.from('2026-04-14T18:46:03.097Z||22222222-2222-4222-8222-222222222222||junk').toString('base64');
