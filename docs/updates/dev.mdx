...
<Update label="February 5, 2026">
  ...
  - See the full [checkpoints documentation](/implementation-guides/platform/functions/checkpoints) for details.
</Update>
