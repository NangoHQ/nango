...
<Update label="Two-factor authentication" description="July 27, 2026">
  ...
  - **Enable 2FA:** Go to the Profile settings page and click "Enable 2FA", then scan the QR code with Google Authenticator, 1Password, or any TOTP app, and verify a code to finish setup.
