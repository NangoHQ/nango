...
<Update label="OAuth for Management MCP" description="September 22, 2026">
  ...
  ![Management MCP OAuth Screen](/images/changelog/management-mcp-oauth-screen.png)

  We also added more tools the Management MCP:
...
<Update label="Agent sessions updates" description="September 16, 2026">
  Improvements to [agent sessions](/guides/agent-sessions) since the public beta launch:
...
<Update label="Agent sessions (public beta)" description="September 2, 2026">
  Agent sessions are a new interface for AI agents to use integrations, now in public beta.
