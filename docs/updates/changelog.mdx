...
<Update label="BYOC self-hosting" description="September 21, 2026">
  ...
  The new [BYOC guide](/guides/platform/self-hosting/byoc) covers this in full detail. BYOC supports AWS and GCP today; Azure is available on request. 
...
<Update label="Billing page improvements" description="September 9, 2026">
  We updated the billing page features to make your spends easier to analsye:
