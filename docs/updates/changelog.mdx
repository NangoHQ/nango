...
<Update label="Audit trail" description="September 3, 2026">
  ...
  Audit trail is available on the [Enterprise plan](https://nango.dev/pricing). See the [audit trail documentation](/guides/platform/audit-trail) for what is recorded.
...
<Update label="Two-factor authentication" description="July 27, 2026">
  ...
  Self-hosted customers: see [Two-factor authentication](/guides/platform/free-self-hosting#two-factor-authentication) for setup instructions.
...
<Update label="Management MCP server (Beta)" description="July 16, 2026">
  ...
  Learn more in the [Management MCP reference](/reference/backend/management-mcp) and the [coding agent setup page](/getting-started/coding-agent-setup#management-mcp-server-beta). Self-hosted instances can enable it by following the [self-hosting guide](/guides/platform/free-self-hosting#management-mcp-server).
