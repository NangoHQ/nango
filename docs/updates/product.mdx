...
<Update label="January 2026">
  ...
  <AccordionGroup>
    <Accordion icon="webhook" title="37 new APIs in December">
      - [3CX](/integrations/all/3cx)
      - [8x8](/integrations/all/8x8)
      - [Adobe Commerce](/integrations/all/adobe-commerce)
      - [Atlassian Service Account (API Token)](/integrations/all/atlassian-service-account-api-token)
      - [Atlassian Service Account (OAuth 2.0)](/integrations/all/atlassian-service-account-oauth2)
      - [Bird](/integrations/all/bird)
      - [Canvas LMS](/integrations/all/canvas-lms)
      - [Cloudbeds](/integrations/all/cloudbeds)
      - [Constant Contact](/integrations/all/constant-contact)
      - [DemoDesk](/integrations/all/demodesk)
      - [Crisp (Plugin Install)](/integrations/all/crisp-plugin-install)
      - [ECU360 (Test)](/integrations/all/ecu360)
      - [ECU360 (Production)](/integrations/all/ecu360-production)
      - [FreeAgent](/integrations/all/freeagent)
      - [FreeAgent (Sandbox)](/integrations/all/freeagent-sandbox)
      - [Google Meet](/integrations/all/google-meet)
      - [Greenhouse Harvest Partner (V3)](/integrations/all/greenhouse-harvest-partner)
      - [Greenhouse Harvest (Client Credentials V3)](/integrations/all/greenhouse-harvest-oauth2-cc)
      - [Looker](/integrations/all/looker)
      - [Meta Marketing API](/integrations/all/meta-marketing-api)
      - [Juniper Mist](/integrations/all/juniper-mist)
      - [Mollie](/integrations/all/mollie)
      - [ModMed](/integrations/all/modmed)
      - [Nerdio](/integrations/all/nerdio)
      - [nocrm.io](/integrations/all/nocrm)
      - [Oomnitza](/integrations/all/oomnitza)
      - [Perdoo](/integrations/all/perdoo)
      - [Pylon](/integrations/all/pylon)
      - [Procore](/integrations/all/procore)
      - [Reapit Connect](/integrations/all/reapit)
      - [Schwab](/integrations/all/schwab)
      - [ServiceNow (Client Credentials)](/integrations/all/servicenow-oauth2-cc)
      - [Stripe (API Key)](/integrations/all/stripe-api-key)
      - [Wiseagent](/integrations/all/wiseagent)
      - [WorkOS](/integrations/all/workos)
      - [Workday (Refresh Token Auth)](/integrations/all/workday-refresh-token)
      - [Wise (API Key)](/integrations/all/wise-api-key)
    </Accordion>
  </AccordionGroup>
