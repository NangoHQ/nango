...
<Update label="February 2026">
  ...
  See the [Sync checkpoints documentation](/implementation-guides/use-cases/syncs/checkpoints) and the [Migration guide](/implementation-guides/platform/migrations/migrate-to-checkpoints).
  ...
  See the [AI integration builder guide](/guides/platform/ai-integration-builder) and [AI agents documentation](/implementation-guides/platform/functions/leverage-ai-agents).
