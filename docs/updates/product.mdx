...
If you have tests using the old multi-file mock format, see [migrating from the old format.](/implementation-guides/platform/functions/testing#migrating-from-the-old-format)
