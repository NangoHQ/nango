...
<Update label="February 2026">
  ...
  **Migration Note:** Checkpoints replace the legacy `last_sync_date` and `syncType`behavior. Follow the [Migration guide](/implementation-guides/platform/migrations/migrate-to-checkpoints) to move to Sync checkpoints.
