...
<Update label="February 2026">
  ...
  **Migration Note:** Checkpoints are a more flexible replacement of `nango.lastSyncDate`. We also removed the concepts of incremental vs. full syncs from the function signature. Follow the [Migration guide](/implementation-guides/platform/migrations/migrate-to-checkpoints) to move to Sync checkpoints.
