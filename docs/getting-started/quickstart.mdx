...
The steps below show the flow end to end. This quickstart uses the GitHub API as an example, but you can choose any of the [1,000+ APIs](/integrations/overview).
...
<Steps>
  ...
  <Step id="choose-next-steps" title="Next steps">
    <CardGroup cols={2}>
      ...
      <Card title="Expose tools to agents" icon="robot" href="/guides/agent-sessions">
