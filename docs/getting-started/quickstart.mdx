...
The steps below show the flow end to end. This quickstart uses the GitHub API as an example, but you can choose any of the [1000+ APIs](/integrations/overview).
