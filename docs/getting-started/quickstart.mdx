...
<div className="agent-quickstart-actions agent-quickstart-actions--single">
  <button
    type="button"
    className="agent-quickstart-action agent-quickstart-action--primary"
    data-copy-url="/prompts/onboarding-nango-customers.txt"
    data-copy-success="Prompt copied"
  >
    <span className="agent-quickstart-action-title">Copy AI quickstart prompt</span>
    <span className="agent-quickstart-action-description">Paste it into your coding agent to walk through this quickstart.</span>
  </button>
</div>
