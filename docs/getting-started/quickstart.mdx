...
<Tip>
  **Using a coding agent?** Set up the [docs MCP server](/getting-started/build-with-ai#docs-mcp-server) and [Nango skills](/getting-started/build-with-ai#skills), then click **Copy page** in the top right and paste this page into your agent.
</Tip>
