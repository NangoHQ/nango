...
<Steps>
  ...
  <Step title="Next steps">
    <CardGroup cols={2}>
        <Card title="Embed in your app" icon="code" href="/guides/primitives/auth#guide">
            Embed Nango Auth in your application and let your users connect external APIs.
        </Card>
        <Card title="Make authenticated requests" icon="plug" href="/implementation-guides/platform/proxy/implement-requests-proxy">
