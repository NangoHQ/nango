...
<Steps>
  ...
  <Step title="Next steps">
    <CardGroup cols={2}>
        <Card title="Embed in your app" icon="code" href="/guides/auth/overview#guide">
            Embed Nango Auth in your application and let your users connect external APIs.
        </Card>
        <Card title="Make authenticated requests" icon="plug" href="/guides/platform/proxy/implement-requests-proxy">
            Use the Proxy to make authenticated API requests on behalf of your users.
        </Card>
        <Card title="Custom integrations" icon="wand-magic-sparkles" href="/guides/functions/overview">
