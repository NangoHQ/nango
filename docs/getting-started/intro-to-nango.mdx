...
<CardGroup cols={2}>
  ...
  <Card title="Try the AI Builder" icon="wand-magic-sparkles" href="/guides/primitives/functions#ai-builder">
...
<CardGroup cols={2}>
  ...
  <Card title="Functions guide" icon="code" href="/guides/primitives/functions#setup">
    Write and deploy TypeScript integration functions.
  </Card>
  <Card title="AI Builder" icon="wand-magic-sparkles" href="/guides/primitives/functions#ai-builder">
