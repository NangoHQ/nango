...
Install the skill to wire Nango into your product:

```bash
npx skills add NangoHQ/skills -s onboarding-nango-customers
```

Install the skill to implement Nango integration functions:
