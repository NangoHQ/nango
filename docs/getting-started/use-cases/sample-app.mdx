...
<Steps>
  ...
  <Step title="Bonus: Deploy custom functions">
    ...
    - Optionally customize the functions using [this guide](/guides/functions/overview).
...
- [Auth guide](/guides/auth/overview) - understand the authorization flow used by the sample app.
- [Sync functions](/guides/functions/sync-functions) - customize the data sync logic.
