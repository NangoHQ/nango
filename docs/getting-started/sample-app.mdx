...
<Steps>
  ...
  <Step title="Bonus: Deploy custom functions">
    ...
    - Optionally customize the functions using [this guide](/guides/primitives/functions).
...
- [Auth guide](/guides/primitives/auth) - understand the authorization flow used by the sample app.
- [Sync functions](/implementation-guides/platform/functions/sync-functions) - customize the data sync logic.
- [Webhooks from Nango](/implementation-guides/platform/webhooks-from-nango) - process sync and auth notifications.
