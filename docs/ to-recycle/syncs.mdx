...
- Syncs are defined once and run in the context of each [Connection](/guides/primitives/auth#what-is-a-connection%3F) (API key or access token of your user)
...
Nango then executes the sync for each [Connection](/guides/primitives/auth#what-is-a-connection%3F) of this integration. This lets you customize the sync's logic, execution frequency, etc., for each customer, if necessary.
