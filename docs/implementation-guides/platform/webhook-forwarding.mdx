...
For processing the webhook inside Nango function code, use [webhook functions](/implementation-guides/platform/functions/webhook-functions).
...
Verify forwarded webhooks the same way you verify other webhooks from Nango. See [Verifying webhooks from Nango](/implementation-guides/platform/webhooks-from-nango#verifying-webhooks-from-nango).
...
Use [webhook functions](/implementation-guides/platform/functions/webhook-functions) when Nango should update records, normalize the payload, or run connection-scoped integration logic immediately.
...
For retry behavior, timeout limits, and local testing tips, see [Webhook retries & debugging](/implementation-guides/platform/webhooks-from-nango#webhook-retries-and-debugging) and [Webhook limits](/guides/platform/limits#webhook-limits).

## Related guides

- [Webhook functions](/implementation-guides/platform/functions/webhook-functions)
- [Process external webhooks](/implementation-guides/use-cases/webhooks-from-external-apis)
- [Receive webhooks from Nango](/implementation-guides/platform/webhooks-from-nango)
