...
<Accordion title="⚠️ Required for OAuth APIs">
    ...
    For OAuth2 providers, Nango surfaces a list of **suggested scopes** in the integration settings. These are discovered and maintained automatically by an agent and refreshed at least once a month. They are suggestions only, you can use any scope the provider supports, depending on your use case.
