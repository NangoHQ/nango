...
Make sure you have an [integration configured](/implementation-guides/platform/auth/configure-integration) in your environment, and at least one [connection](/guides/primitives/auth#what-is-a-connection%3F) available for it.
