...
- The only solution is to ask the user to re-authenticate. See: [How to trigger a re-authentication flow in Nango](/guides/primitives/auth#re-authorize-an-existing-connection)
