...
- [Functions guide](/guides/primitives/functions) - understand the current TypeScript-first project layout.
- [Functions CLI](/reference/cli) - deploy and dry-run migrated functions.
- [Testing](/implementation-guides/platform/functions/testing) - verify migrated integrations before rollout.
