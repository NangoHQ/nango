...
Checkpoints solve both problems. For a full overview, see the [checkpoints guide](/implementation-guides/platform/functions/checkpoints).
...
- [Checkpoints](/implementation-guides/platform/functions/checkpoints) - understand the new checkpoint model.
- [Sync functions](/implementation-guides/platform/functions/sync-functions) - update sync implementations.
- [Testing](/implementation-guides/platform/functions/testing) - test checkpoint filtering.
