...
Nango supports real-time syncs using [webhook functions](/implementation-guides/platform/functions/webhook-functions). You can rely entirely on webhooks or combine them with polling to ensure you never miss data.
...
- Webhooks from the external API enabled. Follow [Webhook functions](/implementation-guides/platform/functions/webhook-functions).
- A sync function for the object you want to sync. See [Sync functions](/implementation-guides/platform/functions/sync-functions).
...
- [Webhook functions](/implementation-guides/platform/functions/webhook-functions) - process external API webhooks in Nango.
- [Webhook forwarding](/implementation-guides/platform/webhook-forwarding) - forward provider webhooks to your app.
- [Sync functions](/implementation-guides/platform/functions/sync-functions) - keep a polling sync as reconciliation.
- [Webhooks from Nango](/implementation-guides/platform/webhooks-from-nango) - consume sync completion notifications.
