...
- [Data Validation](/implementation-guides/platform/functions/data-validation) - Learn more about schema validation
- [Vitest Documentation](https://vitest.dev/) - Official Vitest docs
- [Action functions](/implementation-guides/platform/functions/action-functions) - Building and testing on-demand functions
- [Sync functions](/implementation-guides/platform/functions/sync-functions) - Building and testing sync functions
