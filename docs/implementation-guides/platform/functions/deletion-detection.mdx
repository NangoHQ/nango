---
title: 'Deletion detection'
sidebarTitle: 'Deletion detection'
description: 'Surface deletes from the external API — even when the API itself doesn''t expose them cleanly.'
---
...
- [Sync functions](/implementation-guides/platform/functions/sync-functions) - implement full and incremental syncs.
- [Records cache](/implementation-guides/platform/functions/records-cache) - understand how deleted records are exposed to your app.
- [Sync efficiency](/implementation-guides/platform/functions/sync-efficiency) - reduce API work during delete detection.
- [Functions SDK reference](/reference/functions#delete-records) - deletion helper methods.
