...
- Nango [sync functions](/implementation-guides/platform/functions/sync-functions) can run for up to 24 hours, allowing retries to occur within this window (note that action functions and webhook functions have shorter lifespans; see [Resource limits](/guides/platform/limits))
...
- [Sync efficiency](/implementation-guides/platform/functions/sync-efficiency) - avoid unnecessary provider requests.
- [Action functions](/implementation-guides/platform/functions/action-functions) - design retries for idempotent actions.
