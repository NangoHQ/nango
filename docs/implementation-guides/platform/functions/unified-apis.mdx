...
Validate close to the external API. Use [data validation](/implementation-guides/platform/functions/data-validation) in your functions so mapping drift, malformed provider responses, and invalid write inputs fail at the integration boundary.
...
- [Data validation](/implementation-guides/platform/functions/data-validation)
- [Storage](/implementation-guides/platform/functions/storage)
