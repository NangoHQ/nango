...
- [Sync functions](/implementation-guides/platform/functions/sync-functions) - build the base sync before adding variants.
- [Checkpoints](/implementation-guides/platform/functions/checkpoints) - track progress per variant.
- [Records cache](/implementation-guides/platform/functions/records-cache) - fetch data for each variant.
