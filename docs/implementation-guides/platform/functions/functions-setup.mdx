...
<Note>
    If you're using an AI coding agent to build functions, install the Nango function builder skill after initializing your folder:

    ```bash
    npx skills add NangoHQ/skills
    ```

    This adds `nango-function-builder`, which includes guidance for building both actions and syncs. For more details, read our [guide to building integrations with AI](/implementation-guides/platform/functions/leverage-ai-agents).
</Note>
