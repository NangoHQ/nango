...
- [Action functions](/implementation-guides/platform/functions/action-functions) - validate action inputs and outputs.
- [Sync functions](/implementation-guides/platform/functions/sync-functions) - validate synced record models.
- [Unified APIs](/implementation-guides/platform/functions/unified-apis) - normalize provider data behind stable schemas.
- [Testing](/implementation-guides/platform/functions/testing) - cover validation behavior in tests.
