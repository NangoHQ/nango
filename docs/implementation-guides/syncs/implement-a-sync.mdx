...
If you are using a pre-built integration template sync, you can [skip to the second section](#how-to-use-a-sync).
...
Integration templates are a starting point. You will likely need to [customize them](/implementation-guides/building-integrations/customize-integration-template) or [create your own custom sync](#how-to-build-a-sync).
