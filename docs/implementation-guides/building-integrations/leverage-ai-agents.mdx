...
This uses [prpm](https://prpm.dev), a package manager for AI prompts and skills that lets you install pre-built workflows directly into your development environment.
