...
When certain things happen for a Connection, Nango triggers an event. You can register an event handler [Function](/guides/platform/functions) for a specific event and integration.
...
- [Leveraging AI agents guide](/implementation-guides/building-integrations/leverage-ai-agents) to build with Claude Code, Cursor & other AI agents
