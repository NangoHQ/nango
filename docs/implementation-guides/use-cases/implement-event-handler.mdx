...
- [Event functions](/implementation-guides/platform/functions/event-functions) - supported events, function syntax, testing, and deployment.
- [Webhook functions](/implementation-guides/platform/functions/webhook-functions) - register and process external webhooks.
- [Storage](/implementation-guides/platform/functions/storage) - store account context on the connection.
