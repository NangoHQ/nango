...
sidebarTitle: 'Handle lifecycle events'
description: 'Guide on how to implement a lifecycle event handler in Nango'
---

## What are lifecycle events?

Lifecycle events let you customize Nango's behavior at different points in a [Connection](/guides/primitives/auth#overview)'s lifecycle.
...
See the [lifecycle events reference](/reference/functions#createonevent) for details.
...
- [Build with AI](/guides/primitives/functions#guide) to author event handlers with Claude Code, Cursor, and other coding agents
