...
- Each webhook gets attributed to its corresponding [connection](/guides/use-cases/api-auth#what-is-a-connection) (a user or organization that has set up a specific integration)
