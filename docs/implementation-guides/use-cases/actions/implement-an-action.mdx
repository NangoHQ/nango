...
<Tip>
    If you prefer to automate this, see [build with AI](/guides/primitives/functions#guide) in the Functions guide.
</Tip>
...
- [Build with AI](/guides/primitives/functions#guide) to author actions with Claude Code, Cursor, and other coding agents
...
Integration templates are a starting point. You will likely need to [customize them](/guides/primitives/functions#guide) or [create your own custom action](#how-to-build-an-action).
