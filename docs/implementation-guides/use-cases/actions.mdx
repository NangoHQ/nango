...
For continuously replicated data, use [Sync external API data](/implementation-guides/use-cases/syncs) instead.
...
- [Functions guide](/guides/primitives/functions) - create, test, deploy, and trigger functions end to end.
- [Action functions](/implementation-guides/platform/functions/action-functions) - synchronous calls, async execution, retries, and workflows.
- [Tool calling for AI agents](/implementation-guides/use-cases/tool-calling) - use functions as AI tools.
- [Build a unified API](/implementation-guides/use-cases/unified-apis) - use functions behind a normalized product API.
