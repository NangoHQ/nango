...
<Note>
  You can enable a pre-built action function directly from the dashboard, then skip to step 2.
</Note>

<Steps>

<Step title="Build & deploy your action function">

Follow the [Functions guide](/guides/primitives/functions#guide) — pick the **HTTP** tab to scaffold an action function, then test, and deploy it.
