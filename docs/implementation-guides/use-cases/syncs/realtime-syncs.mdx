...
This is more resource intensive, but can be a good compromise if you are only syncing data for a handful of [Connections](/guides/primitives/auth#what-is-a-connection%3F).
