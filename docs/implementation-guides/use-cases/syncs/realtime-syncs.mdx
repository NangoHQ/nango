...
Nango supports real-time syncs using [webhooks from external APIs](/implementation-guides/use-cases/webhooks-from-external-apis). You can rely entirely on webhooks or combine them with polling to ensure you never miss data.
...
- Webhooks from the external API enabled. Follow our [webhooks from external APIs guide](/implementation-guides/use-cases/webhooks-from-external-apis).
- A sync function for the object you want to sync. See the [main sync guide](/implementation-guides/use-cases/syncs#guide).
