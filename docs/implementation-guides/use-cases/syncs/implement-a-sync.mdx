...
- [Build with AI](/guides/primitives/functions#guide) to author syncs with Claude Code, Cursor, and other coding agents
...
Integration templates are a starting point. You will likely need to [customize them](/guides/primitives/functions#guide) or [create your own custom sync](#how-to-build-a-sync).
