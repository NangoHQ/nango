...
<CardGroup cols={2}>
    <Card title="HTTP API" href="/reference/api/authentication" icon="cloud" color="#F7D300">
    </Card>
    ...
    <Card href="/reference/sdks/go" title="Go" icon="golang" color="#00add8">
    </Card>
...
<CardGroup cols={2}>
    ...
    <Card title="Functions" href="/reference/functions" icon="code" color="#F7D300">
