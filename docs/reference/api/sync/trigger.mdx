...
Use `reset` to clear the checkpoint and re-fetch all data, or `reset` with `emptyCache` to start completely fresh. See the [checkpoints guide](/implementation-guides/use-cases/syncs#re-syncing-resetting-checkpoints-and-the-cache) for details.