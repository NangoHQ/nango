...
<Warning>
  The `nango.yaml` configuration file is deprecated and should not be used for new integrations. If you are still using it, please refer to [this migration guide](/implementation-guides/platform/migrations/migrate-to-zero-yaml).
</Warning>
...
<ResponseField name="sync_type" type="incremental | full" required>
  ...
  Learn more about [incremental vs. full refresh](/implementation-guides/use-cases/syncs/large-datasets) syncing.
</ResponseField>
...
<ResponseField name="input" type="string">
  ...
  Sync inputs are passed from your app to the sync function via the [connection metadata](/implementation-guides/use-cases/customer-configuration).
</ResponseField>
...
<ResponseField name="track_deletes" type="boolean">
  ...
  <Info>
    [Follow this guide](/implementation-guides/use-cases/syncs/deletion-detection) to add support for deletion detection to your syncs.
...
<ResponseField name="webhook-subscriptions" type="string | string[]">
  Lists the types of external webhooks the sync function will handle. Multiple syncs can listen to the same subscription. Learn more about [handling external webhooks in syncs](/implementation-guides/use-cases/syncs/realtime-syncs).
</ResponseField>
...
<Tip>
  ...
  Read the [Execute functions based on events](/implementation-guides/use-cases/implement-event-handler) guide.
</Tip>
