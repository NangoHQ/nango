...
<Expandable>
  ...
  <ResponseField name="integrations_config_defaults" type="object">
    Default configuration for specific integrations. Each entry can include `connection_config` (params rendered as additional form inputs) and `credentials` (values that pre-populate and hide credential fields such as IAM Role ARN).
  </ResponseField>
</Expandable>
...
<Expandable>
  ...
  <ResponseField name="integrations_config_defaults" type="object">
    Default configuration for specific integrations. Include `connection_config` entries for parameter defaults and `credentials` entries to hide/pre-populate credential fields.
  </ResponseField>
</Expandable>
