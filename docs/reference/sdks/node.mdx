...
await nango.listConnections('connection-id', 'search-term', { endUserId: 'user-123' });

// New object parameter syntax (recommended)
await nango.listConnections({
...
**Parameters (Object Syntax - Recommended)**
...
Retrieve a connection given an end user id

```js
await nango.checkConnection(userId);
```
...
{
      "id": 897017,
      "connection_id": "0c24a65d-01e5-48a8-8b91-b5400aa14fb1",
      "provider_config_key": "github",
      "provider": "github",
      "errors": [],
      "end_user": {
        "id": "d88afbc5-3b05-4bb0-8f9a-a59c6ba0e965",
        "display_name": "Some User",
        "email": "someuser@foo.com",
        "tags": null,
        "organization": null
      },
      "metadata": null,
      "created": "2025-10-24T21:48:28.518+00:00"
}
```
</Expandable>
...
Create a connect session for a given end user. A token validity is short lived and lasts for 30 minutes" with "The token is short-lived and lasts for 30 minutes.
