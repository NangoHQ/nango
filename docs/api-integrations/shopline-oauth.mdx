...
<Steps>
    ...
    In Nango ([free signup](https://app.nango.dev)), go to the Integrations tab -> _Configure New Integration_ -> _SHOPLINE (OAuth)_.
    </Step>
    <Step id="authorize" title="Authorize SHOPLINE">
    Go to the Connections tab -> _Add Test Connection_ -> _Authorize_, then log in to SHOPLINE. Later, you'll let your users do the same directly from your app.
    </Step>
