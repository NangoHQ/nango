---
title: Paylocity (Weblink API) - How do I link my account?
sidebarTitle: Paylocity (Weblink API)
---
...
<img src="/api-integrations/paylocity/company_id.png"/>
...
You are now connected to Paylocity.
