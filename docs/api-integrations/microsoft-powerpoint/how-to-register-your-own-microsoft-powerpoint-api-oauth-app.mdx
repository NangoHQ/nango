---
title: 'How to register your own Microsoft PowerPoint OAuth app'
sidebarTitle: 'Microsoft PowerPoint Setup'
description: 'Register an OAuth app with Microsoft PowerPoint and connect it to Nango'
---

This guide shows you how to register your own app with Microsoft PowerPoint (via Microsoft Entra ID) to obtain your OAuth credentials (client ID & secret). These are required to let your users grant your app access to their Microsoft PowerPoint presentations.
...
<Steps>
  ...
  <Step title="Add API permissions">
    ...
    3. Select **Microsoft Graph** to integrate with **Microsoft PowerPoint** via OneDrive/SharePoint.
...
You can find permissions required for each API call in their corresponding API methods section. For example, to access PowerPoint files via OneDrive, see [Microsoft Graph Files API permissions](https://learn.microsoft.com/en-us/graph/api/resources/onedrive).
