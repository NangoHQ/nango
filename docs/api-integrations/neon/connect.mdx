...
<img src="/api-integrations/neon/api_key.png" alt="Neon console API keys page with the newly created API key" />
...
<img src="/api-integrations/neon/form.png" alt="Nango Connect UI form with an API Key field for Neon" style={{maxWidth: "450px" }}/>
