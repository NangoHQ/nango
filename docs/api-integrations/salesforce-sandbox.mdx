...
<Steps>
    ...
    Let's make your first request to the Salesforce Sandbox API. Replace the placeholders below with your [Environment API key](/reference/backend/http-api/api-keys), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections):
    <Tabs>
        <Tab title="cURL">
...
- [How do I link my account?](/api-integrations/salesforce-sandbox/connect)  
Connect your Salesforce sandbox account, including custom sandbox domains
