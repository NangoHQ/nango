...
<Steps>
    ...
    Make your first request to the Supabase REST API (query a table). Replace the placeholders below: use your [Environment API key](/reference/backend/http-api/api-keys), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections), and replace `<your_table>` with your table name (e.g. `todos`, `users`).
    <Tabs>
        <Tab title="cURL">
