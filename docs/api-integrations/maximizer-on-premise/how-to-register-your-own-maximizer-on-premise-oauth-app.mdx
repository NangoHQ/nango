---
title: 'How to register your own Maximizer (On-Premise) OAuth app'
sidebarTitle: 'Maximizer (On-Premise) Setup'
description: 'Register an OAuth app with Maximizer (On-Premise) and connect it to Nango'
---
