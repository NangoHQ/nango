---
title: 'Set up Stitch (MCP) with Nango'
sidebarTitle: 'Stitch (MCP) Setup'
description: 'Register an OAuth app with Google for the Stitch MCP API and connect it to Nango'
---
