---
title: 'How to register your own Microsoft Dataverse OAuth app'
sidebarTitle: 'Microsoft Dataverse Setup'
...
<Steps>
  ...
  <Step id="add-api-permissions" title="Add API permissions">
    ...
    3. Under **Delegated permissions**, check **user_impersonation** ("Access Common Data Service as organization users").
