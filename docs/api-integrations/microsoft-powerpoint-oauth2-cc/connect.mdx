---
title: Microsoft PowerPoint (Client Credentials) - How do I link my account?
sidebarTitle: Microsoft PowerPoint (Client Credentials)
---

# Overview

To connect Microsoft PowerPoint in Nango, you need to provide:
...
4. In the **Register an application** section, enter a meaningful application name to display to users (e.g. `Nango PowerPoint`). Under **Supported account types**, leave it to the default one which is **Single tenant Only** and click **Register**.
...
1. Open the form where you need to authenticate with Microsoft PowerPoint.
2. Enter the **Tenant ID**, **Client ID**, and **Client Secret** in their designated fields.
3. Submit the form, and you should be successfully authenticated.

<img src="/api-integrations/microsoft-powerpoint-oauth2-cc/form.png" alt="Nango Connect UI form with Tenant ID, Client ID, and Client Secret fields for Microsoft PowerPoint" style={{maxWidth: "450px" }}/>

You are now connected to Microsoft PowerPoint.
