...
<img src="/api-integrations/nerdio/nerdio_rest_api_settings.png" alt="Nerdio REST API Settings"/>

5. Once enabled, copy the following values from the **REST API Credentials** section:
   - **Client ID** - The Application (client) ID
   - **Tenant ID** - Your Azure AD Tenant ID

<img src="/api-integrations/nerdio/nerdio_credentials.png" alt="Nerdio REST API Credentials"/>
...
<img src="/api-integrations/nerdio/form.png" style={{maxWidth: "450px" }}/>
