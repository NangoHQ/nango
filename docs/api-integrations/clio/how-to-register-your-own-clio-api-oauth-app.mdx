...
<Steps>
  <Step title="Find your Clio region">
    Clio uses regional hostnames. Log in to your Clio account and note which hostname you are on:
    - **US**: `app.clio.com`
    - **EU**: `eu.app.clio.com`
    - **CA**: `ca.app.clio.com`
    - **AU**: `au.app.clio.com`

    You will need to provide this hostname when configuring your Nango connection.
  </Step>
