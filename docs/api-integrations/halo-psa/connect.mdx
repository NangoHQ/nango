...
<img src="/api-integrations/halo-psa/api-details.png" style={{maxWidth: "450px" }} />
...
For initial smoke testing, `all` is a useful temporary scope. For production use, replace it with the smallest scope set your integration needs, such as `read:tickets`, `edit:tickets`, `read:customers`, `read:assets`, `edit:assets`, `read:timesheets`, `read:contracts`, or `read:items`.
