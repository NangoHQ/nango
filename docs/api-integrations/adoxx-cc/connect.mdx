...
2. In the **Base URL** field, enter the URL where the instance can be reached from other machines, e.g. `http://<SERVER_NAME>:<TOMCAT_PORT>/ADONIS16_0/` (default port is `8000`). This is the value you'll enter as **Base URL** in Nango.
3. Click **Select users** and choose the technical user created in step 1.
4. Click **Save**.
