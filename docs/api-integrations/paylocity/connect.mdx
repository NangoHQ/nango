...
3. **Client ID** - A key that is used to identify your Paylocity account.
...
- You need API access enabled for your Paylocity account.
...
<img src="/integrations/all/paylocity/company_id.png"/>
...
<img src="/api-integrations/paylocity/form.png" style={{maxWidth: "450px" }}/>

You are now connected toPaylocity (NextGen).
