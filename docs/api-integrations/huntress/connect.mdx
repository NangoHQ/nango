...
5. Copy the generated **API Key** and **API Secret** and store them securely. The Environment API key is no longer available after you navigate away from this page.
...
<img src="/api-integrations/huntress/huntress_connect_ui.png" style={{maxWidth: "520px" }} />
