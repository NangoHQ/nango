...
You can automate subscription creation for new connections using a [post-connection-creation script](/implementation-guides/platform/functions/event-functions):
