...
<Steps>
    ...
    Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, enter your simPRO build name (the subdomain part of your simPRO URL — e.g. "trainar" for trainar.simprosuite.com), then log in. Later, you'll let your users do the same directly from your app.
    </Step>
