...
Create a webhook subscription for each new Cal.com connection. You can automate this with a [post-connection-creation script](/guides/functions/event-functions):
