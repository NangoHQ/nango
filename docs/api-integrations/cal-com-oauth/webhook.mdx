...
Create a webhook subscription for each new Cal.com connection. You can automate this with a [post-connection-creation script](/implementation-guides/platform/functions/event-functions):
