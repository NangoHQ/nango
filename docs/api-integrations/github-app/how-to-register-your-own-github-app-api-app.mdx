...
<Steps>
    ...
    <Step title="Configure webhook settings">
        ...
        3. Under **Webhook secret**, enter the webhook secret from your Nango integration configuration. This is required. GitHub only signs webhook payloads when the secret is set, and Nango verifies every payload it receives. Keep it secure and never expose it publicly.
