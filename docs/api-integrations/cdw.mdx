...
<Steps>
    ...
    Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then enter your subscription key (leave **Environment** on production unless you subscribed via CDW's PreProd sandbox). Later, you'll let your users do the same directly from your app.
    </Step>
