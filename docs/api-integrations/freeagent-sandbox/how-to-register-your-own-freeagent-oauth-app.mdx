...
<Steps>
  ...
  <Step title="Register your application">
    ...
    4. Submit the form, and your app will be generated. The **OAuth identifier** will be your Client ID and the **OAuth secrets** will be your Client Secret needed to configure this in Nango.
  </Step>
  <Step title="Next">
