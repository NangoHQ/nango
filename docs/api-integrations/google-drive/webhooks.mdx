...
<Warning>
With no secret saved, Nango has nothing to check the channel token against and forwards every notification that reaches the webhook URL unverified. Set the secret before you create any channel.
</Warning>
