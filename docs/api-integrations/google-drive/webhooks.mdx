...
export default createSync({
    ...
    exec: async (nango) => {
        ...
        const driveId = connection.connection_config['googleDriveWatchDriveId']; // undefined when watching "My Drive"
...
- Update `connection_config` from your own Nango functions via `nango.updateConnectionConfig()`.
