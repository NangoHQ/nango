...
description: 'Learn how to sync files and folders from Google Drive using Nango template sync functions'
---

This guide shows you how to use Nango's template sync functions to automatically sync files and folders from Google Drive into your application. The template sync functions handle authentication, pagination, and incremental updates so you can focus on building your product.

## Available template functions

Nango provides several template functions for Google Drive:
...
All template functions can be extended and customized to fit your needs:
...
- [Sync functions](/implementation-guides/platform/functions/sync-functions)
