...
- [How to set up a Microsoft Teams multitenant OAuth app](/api-integrations/microsoft-teams/how-to-set-up-microsoft-teams-multitenant-oauth-app)  
Publish a Microsoft Teams OAuth app accessible from any tenant, including publisher verification and Partner Center enrollment
