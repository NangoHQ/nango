...
- [How to set up webhooks with Microsoft Teams on Nango](/api-integrations/microsoft-teams-bot/webhooks)  
Receive bot activities from Teams. The bot must use the same Microsoft Entra app as this integration
