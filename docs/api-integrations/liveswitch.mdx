...
<Steps>
    ...
    Fetch the current user. The LiveSwitch provider includes the required `me` scope by default. Replace the placeholders below with your Nango secret key, integration ID, and connection ID:
    <Tabs>
        <Tab title="cURL">
