...
You can automate this for new connections with a [post-connection-creation script](/implementation-guides/platform/functions/event-functions):
...
See: [Real-time syncs](/implementation-guides/platform/functions/realtime-syncs)
</Note>
...
To do this in bulk, iterate over the [list connections](/reference/api/connections/list) response and [update the metadata](/reference/api/connections/update-metadata) for each one.
