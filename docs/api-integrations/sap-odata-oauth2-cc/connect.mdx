...
<img src="/api-integrations/sap-odata-oauth2-cc/enable_oauth.png" />
6. Save the configuration.
7. Double-click **Alias** and validate that the SAP System Alias is correct for the Service Doc Identifier.
<img src="/api-integrations/sap-odata-oauth2-cc/service_alias.png" />
...
<img src="/api-integrations/sap-odata-oauth2-cc/oauth2_enabled.png" />

8. Go to transaction code `SICF`.
9. Navigate to the service **authorize** under path: `default_host/sap/bc/sec/oauth2/`.
<img src="/api-integrations/sap-odata-oauth2-cc/oauth_sicf.png" />
...
<img src="/api-integrations/sap-odata-oauth2-cc/oauth_sicf_token.png" />
...
<img src="/api-integrations/sap-odata-oauth2-cc/soauth2_scope.png" />
...
<img src="/api-integrations/sap-odata-oauth2-cc/form.png" style={{maxWidth: "450px" }}/>
