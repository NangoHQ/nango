...
1. **API Key (Client ID)** - The API key from your approved Availity application.
2. **Client Secret** - The secret key from your approved Availity application.
...
6. Select **Access this Product** to view available subscription plans for the selected API product.
   ...
   **Subscription Plans:**
   ...
   - **Standard Plan**: Full access to REST APIs and production data. Requires contract approval from Trading Partner Management team.
...
2. Enter your **API Key** (Client ID) in the designated field.
3. Enter your **Client Secret** in the designated field.
