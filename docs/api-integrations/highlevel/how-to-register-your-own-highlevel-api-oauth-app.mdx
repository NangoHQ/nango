---
title: 'How to register your own HighLevel OAuth app'
sidebarTitle: 'HighLevel Setup'
description: 'Register an OAuth app with HighLevel and connect it to Nango'
---
