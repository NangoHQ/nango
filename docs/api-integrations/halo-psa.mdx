...
Receive Halo events for a specific connection and run sync functions for the events you need.
See [Set up Halo PSA webhooks](/api-integrations/halo-psa/webhooks) for configuration and authentication steps.
