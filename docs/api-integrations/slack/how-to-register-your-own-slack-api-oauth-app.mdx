...
<Steps>
  ...
  <Step title="Create & configure a Slack app">
    ...
    - User token Scopes access user data and act on behalf of users that authorize them. They will be [added](/reference/api/connect/sessions/create) to Nango when creating a Slack connection.
  </Step>
