---
title: 'Set up Discogs with Nango'
...
<Steps>
  <Step id="create-discogs-account" title="Create a Discogs account">
    If you do not already have one, sign up for a free account at [Discogs](https://www.discogs.com/).
  </Step>
  <Step id="open-developer-settings" title="Open developer settings">
    Go to [Discogs Developer settings](https://www.discogs.com/settings/developers).
  </Step>
  <Step id="create-application" title="Create a new application">
  ...
  <Step id="add-credentials-to-nango" title="Add credentials to Nango">
