---
title: 'How to register your own Microsoft Word OAuth app'
sidebarTitle: 'Microsoft Word Setup'
description: 'Register an OAuth app with Microsoft Word and connect it to Nango'
---
