...
For a complete list of available scopes, refer to [Google's OAuth 2.0 Scopes](https://developers.google.com/identity/protocols/oauth2/scopes). For details on verification requirements, user types, incremental authorization, and rate limits, consult [Google's OAuth 2.0 documentation](https://developers.google.com/identity/protocols/oauth2) and [Google Sheets API documentation](https://developers.google.com/sheets/api/reference/rest).
