...
<Steps>
    ...
    Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then enter your ServiceNow instance domain, Client ID, and Client Secret. Later, you'll let your users do the same directly from your app.
    </Step>
