...
Your **Client ID** and **Client Secret** are configured once on the ServiceNow integration in Nango by whoever set it up — see [How to register your own ServiceNow OAuth app](/api-integrations/servicenow/how-to-register-your-own-servicenow-oauth-app) if that hasn't been done yet. You don't need them to connect an account.
