...
<Steps>
    ...
    <Step title="Configure OAuth scopes">
        ...
        3. Search for and select the API scopes your application needs. Common scopes include `admin`, `user_admin`, `user`, `useraccount`, `web_service_admin`, `web_service`, `personalize`, and `impersonate`.
        4. Click **Save**.
    </Step>
    <Step title="Configure OAuth policies">
        1. In your application record, navigate to the **OAuth Policies** tab.
        2. Configure the token lifespans as needed (defaults: 30-minute access tokens, 8-hour refresh tokens).
