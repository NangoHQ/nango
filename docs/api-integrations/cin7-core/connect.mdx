...
#### Step 1: Find your Account ID and Application Key
...
3. Cin7 Core will generate an **Account ID** and **Application Key** under the **Setup** tab of the API Integration page.
4. Click **Save**.
