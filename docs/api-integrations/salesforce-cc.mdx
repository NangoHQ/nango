...
description: 'Integrate your application with the Salesforce API using OAuth2 client credentials'
---

import Overview from "/snippets/overview.mdx"
import PreBuiltTooling from "/snippets/generated/salesforce-cc/PreBuiltTooling.mdx"
...
- [How do I link my account?](/api-integrations/salesforce-cc/connect)  
  Connect your Salesforce account using the Connect UI and get Client ID, Client Secret, and Hostname
