...
3. **Okta Domain** - The full hostname of your Okta organization (e.g. `dev-12345678.okta.com`).
...
4. Enter your **Okta Domain** as the full hostname (e.g., `dev-12345678.okta.com`).
