---
title: 'How to register your own Microsoft People OAuth app'
sidebarTitle: 'Microsoft People setup'
description: 'Register an OAuth app with Microsoft and connect it to Nango'
---
