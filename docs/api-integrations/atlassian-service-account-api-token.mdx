...
## 🧩 Template functions for Atlassian Service Account (API Token)

Enable them in your dashboard. Extend and customize to fit your needs.

import TemplateFunctions from "/snippets/generated/atlassian-service-account-api-token/TemplateFunctions.mdx"
