...
title: 'Zoom'
sidebarTitle: 'Zoom'
description: 'Integrate your application with the Zoom API'
---
...
<Steps>
    ...
    In Nango ([free signup](https://app.nango.dev)), go to [Integrations](https://app.nango.dev/dev/integrations) -> _Configure New Integration_ -> _Zoom_.
    </Step>
    <Step title="Authorize Zoom">
    Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then log in to Zoom. Later, you'll let your users do the same directly from your app.
    </Step>
