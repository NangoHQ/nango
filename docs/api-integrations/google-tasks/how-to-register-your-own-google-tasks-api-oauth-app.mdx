---
title: 'How to register your own Google Tasks OAuth app'
sidebarTitle: 'Google Tasks OAuth Setup'
description: 'Register an OAuth app with Google and connect it to Nango for Google Tasks'
---

This guide shows you how to register your own app with Google Cloud to obtain your OAuth credentials (client ID & secret). These are required to let your users grant your app access to their Google Tasks.
...
<Steps>
  ...
  <Step title="Enable the APIs you need">
    ...
    2. Search for **Google Tasks API** and select it, then click **Enable**.
  </Step>
  ...
  <Step title="Verify your app">
   Google Tasks scopes may be marked "sensitive" or "restricted" by Google. You can develop your integration in test mode, but you may need to pass a security review to go live.
