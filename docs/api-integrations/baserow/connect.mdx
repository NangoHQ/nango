...
<img src="/api-integrations/baserow/dashboard.png" alt="Baserow account settings with the Database tokens section open"/>
...
<img src="/api-integrations/baserow/generated_api_key.png" alt="Newly generated Baserow database token with the copy option highlighted"/>
...
<img src="/api-integrations/baserow/form.png" alt="Nango Connect UI form with fields for Base URL and Database Token" style={{maxWidth: "450px" }}/>
