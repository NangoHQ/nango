...
-   Webhook payloads are signed with the webhook secret you configured on your GitHub App. The secret is required. Nango verifies the signature on every payload and rejects anything that arrives unsigned.
