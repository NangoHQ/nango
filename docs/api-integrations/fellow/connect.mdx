...
<img src="/api-integrations/fellow/user_settings.png"/>

2. Click **API & MCP connections**, then click **+ New API Key**
<img src="/api-integrations/fellow/api_settings.png"/>

3. Enter a name for your API Key and click **Generate Key**
<img src="/api-integrations/fellow/api_key.png"/>
...
<img src="/api-integrations/fellow/form.png" style={{maxWidth: "450px" }}/>
