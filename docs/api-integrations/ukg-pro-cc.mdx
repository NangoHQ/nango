...
<Steps>
    ...
    Make your first request to the UKG Pro Recruiting API. Replace the placeholders with your [Environment API key](/reference/backend/http-api/api-keys), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections). Use the **tenant ID** from your connection's connection config in the path (e.g. `UO32145HGOGOG`):
    <Tabs>
        <Tab title="cURL">
