...
4. In the **Register an application** section, enter a meaningful application name to display to users (e.g. `Nango Intune`). Under **Supported account types**, select **Accounts in any organizational directory (Multitenant)** and click **Register**.
