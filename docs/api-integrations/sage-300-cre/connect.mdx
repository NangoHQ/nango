...
- Network access (HTTPS) from wherever Nango's proxy runs to that server — since it's on-premise, this usually means a VPN, firewall allow-list, or a public-facing endpoint your admin sets up.
