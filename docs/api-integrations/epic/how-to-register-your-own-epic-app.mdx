...
<Steps>
  <Step title="Register your app with Epic's App Market">
  ...
  <Step title="Host a JWKS file with your public key">
  ...
  <Step title="Register your JWKS URL with Epic">
  ...
  <Step title="Enter your credentials in Nango">
