...
<Steps>
    ...
    Go to [Connections](https://app.nango.dev/dev/connections) -> _Add Test Connection_ -> _Authorize_, then enter your NetSapiens server hostname, username, password, client ID, and client secret. Later, you'll let your users do the same directly from your app.
    </Step>
