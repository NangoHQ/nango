...
- You must have a Google account you must have a Google account and billing enabled in the Google Cloud Platform
...
2. Click **+ Create Credentials** and select **API key**, enter a name and select the APIs you enabled earlier.
