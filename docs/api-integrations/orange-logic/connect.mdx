...
Your Orange Logic Server URL is the base URL of your Orange Logic instance (e.g., `mycompany.orangelogic.com`). You can find it in the address bar when logged into Orange Logic.
