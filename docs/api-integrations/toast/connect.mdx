...
3. **API Hostname** - The Toast API hostname for your environment.
...
5. Copy your **API Hostname**. **Client ID** and **Client Secret**, the secret is only shown once.
...
3. Enter the **API Hostname** for your environment.
