...
This guide walks you through finding or creating a **Private API Key** in Builder.io.
...
Different APIs within Builder.io use different domains. The **Content API** uses `cdn.builder.io`; the **Write API** uses your space domain. For details see [API Intro](https://www.builder.io/c/docs/api-intro).
