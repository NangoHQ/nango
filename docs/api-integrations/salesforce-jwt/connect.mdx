...
2. In **Setup**, 
3. From the left navigation, navigate to **Apps** > **External Client Apps**, then select **Settings**.
...
1. From the left navigation go to **App Manager** then click the drop down to the far right of you applicaton, then click the dropdown and click manage.
