...
<Steps>
    ...
    Review the [LiveSwitch authentication guide](https://developer.liveswitch.com/docs/basic-concepts). Nango's LiveSwitch provider requests the documented identity, organization, conversation, project, contact, recording, document, tag, webhook, and Sparky report scopes by default, including `offline_access` for refresh tokens. Remove scopes in the integration settings if your application deliberately needs less access.
