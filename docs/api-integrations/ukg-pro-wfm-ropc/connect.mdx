...
Use ROPC when actions need to run on behalf of a specific user, such as submitting time records or approving leave requests. If you don't need to impersonate a user, use the [UKG Pro (Workforce Management Client Credentials)](/api-integrations/ukg-pro-wfm-cc/connect) integration instead — it's built for system-to-system calls.
...
<a id="step-3-getting-the-wfm-user-credentials"></a>
