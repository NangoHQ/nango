...
3. Add **Admin API** from the application catalog, or open your existing **Admin API** application.

<img src="/api-integrations/duo-admin/admin-api-catalog.png" alt="Duo application catalog with the Admin API application" />
...
<img src="/api-integrations/duo-admin/admin-api-details.png" alt="Duo Admin API application details page" />

<Tip>Treat your Duo Secret Key like a password. If you rotate it in Duo, reconnect the Nango connection with the new Secret Key.</Tip>
