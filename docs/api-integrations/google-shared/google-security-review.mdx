...
Most importantly:
* Switch to a [custom callback URL in Nango](/guides/auth/auth-guide#custom-oauth-callback-url-optional), and verify the domain of your callback URL in your Google Cloud project.
