...
<Steps>
    ...
    <Step title="Implemet Nango in your app">
...
- [How to set Salesforce up with Nango](/api-integrations/salesforce/salesforce-api-oauth-app-setup)  
Register your own OAuth app and configure Salesforce for production use in Nango

- [How to register your own Salesforce OAuth app](/api-integrations/salesforce/salesforce-api-oauth-app-setup)  
How to register an OAuth app with Salesforce and connect it to Nango
