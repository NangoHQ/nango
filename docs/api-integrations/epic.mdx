...
<Steps>
    ...
    Each connection represents one health system. Create it by supplying that health system's Interconnect Server URL — see the [connect guide](/api-integrations/epic/connect) for the exact fields and the recommended API-based flow.
    </Step>
    ...
    <Step id="implement-in-app" title="Implement Nango in your app">
        ...
        For programmatic connection creation across many health systems, see the [connect guide](/api-integrations/epic/connect).
    </Step>
</Steps>
