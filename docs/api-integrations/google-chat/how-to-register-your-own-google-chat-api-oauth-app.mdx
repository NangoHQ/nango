---
title: 'How to register your own Google Chat OAuth app'
sidebarTitle: 'Google Chat Setup'
description: 'Register an OAuth app with Google Chat and connect it to Nango'
---
