...
- Facebook tokens expire after 60 days and cannot be refreshed. Once a token expires, users must re-authenticate by [re-authorizing the connection](/guides/auth/auth-guide#re-authorize-an-existing-connection).