...
- Facebook tokens expire after 60 days and cannot be refreshed. Once a token expires, users must re-authenticate by [re-authorizing the connection](/guides/primitives/auth#6-re-authorize-an-existing-connection).