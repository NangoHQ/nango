...
3. **Implement re-authorization**: Make sure you have the [re-authorization flow](/guides/auth/overview#re-authorize-an-existing-connection) in place so users can easily reconnect broken connections

## Related guides

- [Auth guide](/guides/auth/overview#re-authorize-an-existing-connection) - implement reconnect sessions for invalid credentials.
