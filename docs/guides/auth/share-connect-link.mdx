...
- [Auth guide](/guides/auth/overview) - embed the standard Connect UI flow.
- [Connection tags](/guides/auth/connection-tags) - reconcile completed links with users and orgs.
- [Create a connect session API](/reference/api/connect/sessions/create) - API details for generated links.
