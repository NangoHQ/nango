...
<Info>
  Pre-requisite: complete the [Set up an integration](/guides/auth/overview#guide) section of the Auth guide.
</Info>
...
This guide extends the [Auth](/guides/auth/overview) flow.
