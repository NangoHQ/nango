...
This guide extends the [Auth](/guides/auth/auth-guide) flow.
...
- [Migrate from end user](/guides/platform/migrations/migrate-from-end-user) - move legacy ownership fields to tags.
