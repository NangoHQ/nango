...
Nango Auth lets your users connect 1000+ external APIs to your product. You embed a Nango-managed auth flow in your application, and Nango handles authorization, credential storage, refresh, and validation.
...
- **Auth schemes** — OAuth 2.0, OAuth 1.0a, API keys, basic auth, custom. 1000+ APIs supported; new ones [added on demand](/integrations/contribute-or-request-api) within days, by request or self-contributed.
