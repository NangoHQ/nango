...
- [Sync functions](/guides/functions/sync-functions) - implement full and incremental syncs.
- [Records cache](/guides/functions/records-cache) - understand how deleted records are exposed to your app.
- [Sync efficiency](/guides/functions/sync-efficiency) - reduce API work during delete detection.
