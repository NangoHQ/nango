...
See [Re-syncing: resetting checkpoints and the cache](/guides/functions/checkpoints#re-syncing-resetting-checkpoints-and-the-cache) in the Checkpoints guide for the `reset` / `emptyCache` options and their implications.
...
- [Sync functions](/guides/functions/sync-functions) - write records into the cache.
- [Sync efficiency](/guides/functions/sync-efficiency) - keep records small and consume changes promptly.
- [Deletion detection](/guides/functions/deletion-detection) - mark records deleted in the cache.
