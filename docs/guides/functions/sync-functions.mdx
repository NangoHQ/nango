...
- [Checkpoints](/guides/functions/checkpoints)
- [Records cache](/guides/functions/records-cache)
- [Deletion detection](/guides/functions/deletion-detection)
- [Real-time syncs](/guides/functions/realtime-syncs)
- [Sync partitioning](/guides/functions/sync-partitioning)
