...
On failure the `ok` field is `false` and `error` contains the error message. This is designed for CI pipelines and agent harnesses that need to parse the dry run result.
