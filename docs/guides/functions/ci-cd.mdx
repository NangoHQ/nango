...
CI/CD for Nango is about keeping your [Functions](/guides/functions/overview) — sync functions, action functions, webhook functions, and event functions — in sync with your application across environments.
