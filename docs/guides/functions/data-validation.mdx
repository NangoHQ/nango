...
Nango offers data validation at two levels: inside your [Nango functions](/guides/functions/overview) (when calling external APIs) and in your application code (when consuming function responses).
...
- [Sync functions](/guides/functions/sync-functions) - validate synced record models.
