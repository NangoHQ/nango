...
Build custom tools with [action functions](/guides/functions/action-functions), or enable template action functions from the [template catalog](/guides/functions/overview#template-catalog).
...
See the [Auth guide](/guides/auth/overview) and [Create Connect Session API](/reference/api/connect/sessions/create) for the end-to-end auth flow.
...
- [Template catalog](/guides/functions/overview#template-catalog)
