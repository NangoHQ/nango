---
title: 'Integration Functions - Overview'
...
Pair Functions with the [AI integration builder](/guides/platform/ai-integration-builder) to generate and maintain integration code faster: Combine the speed of AI with human-reviewable code you fully control.
