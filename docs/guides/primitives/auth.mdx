...
- **Credential management** — Encrypted storage, automatic refresh, retrieval at scale. Combine with [Proxy](/implementation-guides/platform/proxy/implement-requests-proxy) or [Functions](/guides/primitives/functions) to avoid handling credentials directly.
...
<Steps>
  ...
  <Step title="Run the flow">
    ...
    - Build with [sync functions](/implementation-guides/platform/functions/sync-functions), [Action functions](/implementation-guides/platform/functions/action-functions), [webhook functions](/implementation-guides/platform/functions/webhook-functions), or any other Nango function type.
  </Step>
</Steps>
...
- [Share a connect link](/implementation-guides/platform/auth/share-connect-link) - send authorization links by email, support tools, or cross-device flows.
- [Connection tags](/implementation-guides/platform/auth/connection-tags) - attribute connections to users, orgs, and other entities.
- [Customize Connect UI](/implementation-guides/platform/auth/customize-connect-ui) - build your own authorization UI.
- [Token refreshing and validity](/implementation-guides/platform/auth/token-refreshing) - handle revoked or expired credentials.
