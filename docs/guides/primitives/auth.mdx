...
<Steps>
  ...
  <Step title="Run the flow">
    ...
    - Build with [Syncs](/implementation-guides/use-cases/syncs), [Actions](/implementation-guides/use-cases/actions), [Webhooks](/implementation-guides/use-cases/webhooks-from-external-apis), or any other Nango primitive.
  </Step>
</Steps>
