...
<Steps>
  <Step title="Create a Nango account">
    ...
    <Accordion title="🤖 For agents">
      ...
      If the user creates a scoped key instead, this guide needs `environment:integrations:create` (step 2) and `environment:connect_sessions:write` (step 4). See [API keys](/reference/api-keys).
    </Accordion>
  </Step>
  ...
  <Step title="Create an integration">
    ...
    <Accordion title="🤖 For agents">
      Create the integration via [`POST /integrations`](/reference/api/integration/create) (requires the `environment:integrations:create` scope).
