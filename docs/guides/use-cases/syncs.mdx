...
You can also implement two-way syncs by combining syncs with [Actions](/guides/use-cases/actions).
...
Syncs are defined on the integration (e.g., GitHub, Google Drive, etc.) by implementing a [Function](/guides/platform/functions) with the sync's logic.
...
Follow our [implement a sync](/implementation-guides/syncs/implement-a-sync) guide for step-by-step instructions to create your own syncs.
...
Refer to the [implement a sync](/implementation-guides/syncs/implement-a-sync) guide for more information on how to implement either in Nango.
...
Follow our [implement real-time syncs with webhooks](/implementation-guides/syncs/realtime-syncs) guide to add real-time support for your sync.
