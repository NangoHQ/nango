...
Salesforce events come from an Apex trigger you install in each connected org, and use the same per-connection secret. See [How to set up webhooks with Salesforce on Nango](/api-integrations/salesforce/webhooks).
