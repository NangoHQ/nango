...
- **Detailed**: Every operation and every log message contains detailed information about the integration, [connection](/guides/primitives/auth#overview), and [function](/guides/primitives/functions). Error messages are as detailed as the external APIs allow.
...
- [Function logging](/implementation-guides/platform/functions/logging) - add custom logs from function code.
- [Webhooks from Nango](/implementation-guides/platform/webhooks-from-nango#webhook-retries-and-debugging) - debug webhook delivery.
- [Common issues](/implementation-guides/platform/common-issues) - troubleshoot failed auth, sync, and proxy operations.
