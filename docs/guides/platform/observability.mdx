...
Logs are retained for **15 days**, then permanently deleted. 

## Logs MCP tools

The [Management MCP server](/reference/backend/management-mcp#logs) provides tools for listing and filtering log operations and retrieving their messages from an MCP-compatible client.
...
- [Limits](/guides/platform/limits#log-retention) - log retention window.
