...
| Plan | SSO support |
| - | - |
| Free / Starter | Google login only (included in the standard login flow) |
| Growth | SSO with other identity providers available as a paid add-on |
| Enterprise (Cloud) | SSO included |
| Enterprise (Self-hosted) | Not yet available (planned) |

### Supported providers

Through WorkOS, Nango supports the main SSO providers, including **Okta**, **Entra ID**, and others.

### How to enable SSO

1. Contact the [Nango team](https://nango.dev/demo) to enable SSO for your organization.
