...
| GDPR | Data Processing Agreement (DPA) available for all customers. [View DPA →](https://nango.dev/terms#dpa) |
| HIPAA | Business Associate Agreement (BAA) available on request. [Contact us →](https://nango.dev/chat) |
