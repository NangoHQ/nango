...
[Nango logs](/guides/platform/observability) are a separate, operational record of what ran — auth flows, function executions, proxy requests — and can be exported via [OpenTelemetry](/guides/platform/observability#opentelemetry-export).
