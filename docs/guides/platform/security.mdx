...
- **API**: Call the [delete connection endpoint](/reference/api/connections/delete)
...
- [API keys](/reference/api-keys) - create scoped keys for production access.
- [Auth guide](/guides/auth/overview) - keep provider credentials out of your app.
