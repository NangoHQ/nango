...
Separately, [activity logs](/guides/platform/observability) capture what ran — auth flows, function executions, proxy requests — and can be exported via [OpenTelemetry](/guides/platform/observability#opentelemetry-export). They answer "what happened in my integrations", not "who changed my account".
