...
- [Auth guide](/guides/primitives/auth) - keep provider credentials out of your app.
- [Token refreshing and validity](/implementation-guides/platform/auth/token-refreshing) - handle revoked OAuth credentials.
