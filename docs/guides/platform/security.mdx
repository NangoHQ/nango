...
Data is stored in a managed PostgreSQL database in AWS, network-isolated in a private subnet, with automated backups and point-in-time recovery. [BYOC](/guides/platform/self-hosting) deployments run in a cloud account you control, and all retention periods are configurable there.
...
- [BYOC](/guides/platform/self-hosting) - run a dedicated Nango instance in your own cloud account.
