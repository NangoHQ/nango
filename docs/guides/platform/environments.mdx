...
- [API keys](/reference/api-keys) - scope keys per environment.
- [CI/CD](/implementation-guides/platform/functions/ci-cd) - deploy functions safely across environments.
