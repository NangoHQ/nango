...
- [Functions](/guides/functions/overview)
- [Connections](/guides/auth/overview)
...
When you deploy [Functions](/guides/functions/overview), you always target a specific environment. This ensures changes are tested before reaching production.
