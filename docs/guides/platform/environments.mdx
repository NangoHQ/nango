...
<Info>
Each Nango account comes with **dev** and **prod** environments by default. Additional environments are available depending on your [pricing plan](https://www.nango.dev/pricing). Create them from the environment dropdown in the dashboard, or with the [Create an environment API](/reference/backend/http-api/environments/create).
</Info>
...
- [Create an environment](/reference/backend/http-api/environments/create) - create environments via API.
