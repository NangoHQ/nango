...
No customer data, no connection credentials, and no synced records ever leave your environment, in either direction.
...
| Area | Nango | You |
| --- | --- | --- |
| Infrastructure provisioning (VPC, database, cache, cluster) | Provisions it, via Terraform, using the access you grant | Review the Terraform plan; own the underlying cloud bill |
