...
Checkpoints solve both problems. For a full overview, see the [checkpoints guide](/guides/functions/checkpoints).
...
- [Checkpoints](/guides/functions/checkpoints) - understand the new checkpoint model.
- [Sync functions](/guides/functions/sync-functions) - update sync implementations.
