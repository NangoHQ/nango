...
For more details (including limitations and filtering), see [Connection tags](/guides/auth/connection-tags).
...
- [Connection tags](/guides/auth/connection-tags) - use tags for connection attribution.
- [Auth guide](/guides/auth/overview) - create connect sessions with tags.
