...
- The only solution is to ask the user to re-authenticate. See: [How to trigger a re-authorization flow in Nango](/guides/auth/overview#re-authorize-an-existing-connection)
...
- [Auth guide](/guides/auth/overview#re-authorize-an-existing-connection) - repair broken connections with re-authorization.
