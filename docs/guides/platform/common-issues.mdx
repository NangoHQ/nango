...
1. Confirm the environment and API key
   - The Environment API key (`apiKey` / legacy `secretKey`) is specific to the environment. Make sure you pass the key that corresponds to the environment you are using (e.g., dev vs prod).
