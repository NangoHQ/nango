...
<Steps>
    ...
    Scopes are configured at the integration level (default: `platform.companies.read`).
    </Step>
...
No pre-built syncs or actions are currently published for ConnectWise RMM.
