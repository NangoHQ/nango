...
<Note>Contribute useful links by [editing this page](https://github.com/nangohq/nango/tree/master/docs/integrations/all/one-drive.mdx)</Note>
...
For a complete, production-ready implementation of OneDrive for Business integration with Nango, check out the **[Nango Sample App](/getting-started/sample-app)**.

The sample app provides:
- Full OAuth flow implementation
- OneDrive for Business file picker integration
...
<Tip>
The sample app is the fastest way to get started with OneDrive for Business integration. It includes all the code you need and can be customized for your specific use case.
</Tip>
...
<Note>Contribute API gotchas by [editing this page](https://github.com/nangohq/nango/tree/master/docs/integrations/all/one-drive.mdx)</Note>
