...
<img src="/integrations/all/auvik/auvik-left-nav.png" style={{maxWidth: "450px" }}/>
3. Under the **API Key** section, click **Generate**.
<img src="/integrations/all/auvik/auvik-edit-profile.png" style={{maxWidth: "450px" }}/>
4. Copy and securely store your **API Key** – this is separate from your password and will be used for API authentication.
<img src="/integrations/all/auvik/auvik-api-key-modal.png" style={{maxWidth: "450px" }}/>
