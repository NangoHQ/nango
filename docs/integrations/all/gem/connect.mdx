...
- You have already configured the `appSecret` in the **connection configuration**, which was provided externally by Gem when creating a [session](/reference/api/connect/sessions/create)
