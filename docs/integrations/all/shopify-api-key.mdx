...
<Tabs>
  <Tab title="🚀 Quickstart">
   <Warning>
      Starting January 1, 2026, you can no longer create legacy custom apps. We recommend using [Shopify (OAuth)](/api-integrations/shopify) instead. This won't impact any existing apps.
    </Warning>
    <Steps>
    ...
    <Tip>
    Next step: [Embed the auth flow](/guides/primitives/auth) in your app to let your users connect their Shopify stores.
    </Tip>
  </Tab>
  ...
  <Tab title="🚨 API gotchas">
    ...
    - To receive webhooks, set a **Webhook secret** on the integration in the Nango dashboard matching the secret you configure when subscribing the webhook in Shopify. See [How to set up webhooks with Shopify on Nango](/api-integrations/shopify/webhooks).
