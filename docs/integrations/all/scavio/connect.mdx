...
1. Log in to the Scavio dashboard at [dashboard.scavio.dev](https://dashboard.scavio.dev/sign-in), or [create an account](https://dashboard.scavio.dev/sign-up) if you do not have one yet.
