...
2. In the security section of the sidebar select **API Tokens**.
3. Generate an **API Token** using the controls below the **Organization Tokens header**.

<img src="/integrations/all/terraform/organization_settings.png" style={{maxWidth: "450px" }}/>
