  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Call the Microsoft Excel API">
        Let's make your first request to the Microsoft Excel (Microsoft Graph) API (fetch worksheets from a specific workbook). Replace the placeholders below with your [Environment API key](/reference/backend/http-api/api-keys), [integration ID](https://app.nango.dev/dev/integrations), [connection ID](https://app.nango.dev/dev/connections), and a workbook file ID:
        <Tabs>
            <Tab title="cURL">
