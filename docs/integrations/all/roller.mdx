...
- **Quickstart: Embed in your app (connect session token)**: /guides/auth/auth-guide
- **Auth guide**: /guides/auth/auth-guide
- **Proxy requests** (server-side calls through Nango): /guides/platform/proxy-requests
