  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Call the OneLogin API">
        Let's make your first request to the OneLogin API (fetch user information). Replace the placeholders below with your [Environment API key](/reference/backend/http-api/api-keys), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections):
        <Tabs>
            <Tab title="cURL">
    ...
    <Tip>
    Next step: [Embed the auth flow](/guides/primitives/auth) in your app to let your users connect their OneLogin accounts.
    </Tip>
  </Tab>
