...
1. **Access to your AWS account** – enough permission to create an IAM role using the instructions your vendor provides.
...
-   Follow the IAM role setup instructions your vendor surfaces in their onboarding flow (this happens before Connect opens). The role must include an `sts:ExternalId` condition matching the External ID your vendor shared.
