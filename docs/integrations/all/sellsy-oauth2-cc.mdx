  ...
  <Tab title="🚀 Quickstart">
    <Steps>
      ...
      <Step title="Call the Sellsy API">
        Let's make your first request to Sellsy (fetch a list of contacts). Replace the placeholders below with your [Nango Environment API key](https://app.nango.dev/dev/environment-settings), [integration ID](https://app.nango.dev/dev/integrations), and [connection ID](https://app.nango.dev/dev/connections):
