...
<Tabs>
  <Tab title="🚀 Quickstart">
    <Steps>
      <Step title="Create an integration">
        In Nango ([free signup](https://app.nango.dev)), go to [Integrations](https://app.nango.dev/dev/integrations) -> _Configure New Integration_ -> _Zendesk Sell_. You'll need to set up your own OAuth app by following these [instructions](#🧑%E2%80%8D💻-oauth-app-setup). After that, make sure to add the OAuth client ID and secret in the integration settings in Nango.
      </Step>
  ...
  <Tab title="🔗 Useful links">
    ...
    | Developer | [API documentation](https://developers.getbase.com/docs/rest/overview) |
    | | [Authentication guide](https://developers.getbase.com/docs/rest/articles/oauth2/requests) |
    | | [API Reference](https://developers.getbase.com/docs/rest/reference) |
    | | [Rate limits](https://developers.getbase.com/docs/rest/articles/requests#rate-limiting) |
    | | [Scopes and permissions](https://developers.getbase.com/docs/rest/articles/oauth2/scopes) |
  ...
  <Tab title="🚨 API gotchas">
    ...
    - **Pagination**: The API uses cursor-based pagination. Use the `page` and `per_page` parameters for list endpoints.
    - **Field filtering**: Many endpoints support field filtering using the `fields` parameter to reduce response size.
