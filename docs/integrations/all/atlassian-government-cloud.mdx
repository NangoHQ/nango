  ...
  <Tab title="🧑‍💻 OAuth app setup">
    <Steps>
      <Step title="Request access to an AGC developer account">
        If you don't already have one, request access to [Atlassian Government Cloud instance](https://developer.atlassian.com/platform/framework/agc/guides/get-access-to-agc/) for testing purposes. 
      </Step>
