...
1. **API Server**: The API base URL of the SAP S/4HANA cloud API service you want to connect to.
2. **Username**: The username of the Communication User for API access uisng Basic Authentication.
3. **Password**: The password of the Communication User for API access uisng Basic Authentication.
...
5. Select **Communication Management** group from your main menu.
<img src="/integrations/all/sap-odata-basic/communication_management.png" />
...
<img src="/integrations/all/sap-odata-basic/new_user.png" />
...
<img src="/integrations/all/sap-odata-basic/communication_system_config.png" />
...
<img src="/integrations/all/sap-odata-basic/inbound_communication_user.png" />
15. Click **Save**.
...
21. Click **Save**.
<img src="/integrations/all/sap-odata-basic/communication_arrangement.png" />
...
<img src="/integrations/all/sap-odata-basic/form.png" style={{maxWidth: "450px" }}/>
