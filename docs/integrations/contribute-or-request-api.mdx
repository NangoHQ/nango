...
Fork the [repo](https://github.com/NangoHQ/nango) and edit the API configurations file ([providers.yaml](https://github.com/NangoHQ/nango/blob/master/packages/providers/providers.yaml)).
